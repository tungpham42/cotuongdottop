...
@else
<h5 class="text-center my-1" data-toggle="tooltip" data-placement="top" title="Bạn đang đi quân đen">Bạn đã được mời</h5>
@endif
...
<p class="w-100 text-center">
  <a data-step="2" data-intro="Ấn vào đây nếu bạn không biết đi nước nào" id="resign" class="btn btn-dark btn-lg"><i class="fad fa-flag"></i> Bỏ cuộc</a>
</p>
@endif
<script>
@if ($room['pass'] != null)

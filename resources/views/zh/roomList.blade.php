...
<div class="container-fluid game px-0">
  <div class="container p-3">
    ...
    <div data-step="2" data-intro="所有比赛的列表" class="table-responsive">
      <table id="danh-sach-phong" class="table table-bordered table-hover table-striped table-sm">
        <thead class="thead-light">
          <tr>
            <th class="text-center" scope="col">房间名称</th>
            <th class="text-center" scope="col">玩家的轮次</th>
            <th class="text-center" scope="col">结果</th>
            <th class="text-center" scope="col">行动</th>
            <th class="text-center" scope="col">最后播放</th>
          </tr>
        </thead>
  ...
  <div class="modal-dialog modal-dialog-centered" role="document" style="max-width: 320px; margin: auto;">
    <div class="modal-content shadow-lg">
      <div class="modal-header">
        <h5 class="modal-title"><i class="far fa-eye"></i> 「<span></span>」的预览</h5>
...
$(document).ready(function () {
  console.log('List URL: ' + '{{ route('roomsZh.list') }}');
  var table = $('#danh-sach-phong').DataTable({
    ...
    'language': {
      'url': '{{ URL::to('/') }}/js/TableZh.json?v=1'
    },

...
@section('aboveBoard')
<h5 class="text-center my-1" data-toggle="tooltip" data-placement="top" title="玩红色">你是主人</h5>
...
<div id="copy-url-black" class="input-group my-1 w-50 mx-auto pulse-light" data-toggle="tooltip" data-placement="bottom" data-original-title="点击复制">
...
@if ($room['pass'] != null)
<div data-step="2" data-intro="点击这里更改房间密码" id="change-pass" class="input-group my-1 w-50 mx-auto">
  <label class="m-auto" for="inputPassword">新密码</label>
  <input type="password" id="inputPassword" class="form-control mx-2" required />
  <button type="submit" id="changePassword" class="btn btn-dark" onclick="validateForm();">改变</button>
...
<p class="w-100 text-center">
  <a data-step="3" data-intro="如果您没有线索，请点击这里" id="resign" class="btn btn-dark btn-lg"><i class="fad fa-flag"></i> 辞职</a>
</p>
<script>
@if ($room['pass'] != null)

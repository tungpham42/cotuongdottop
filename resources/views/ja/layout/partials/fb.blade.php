<div style="background-color: #312e2b" class="container-fluid comments px-0">
  <div class="container mx-auto px-0">
    <div class="row w-100 mx-auto p-3">
      <h2 class="mb-4 w-100 text-light"><i class="fas fa-comments"></i> コメント</h2>
      <div id="fb-root"></div>
      <script>
      ...
      chatbox.setAttribute("logged_in_greeting", "こんにちは、プレイヤー！");
      chatbox.setAttribute("logged_out_greeting", "どのようにお手伝いできますか？");
...
@if ($roomCode != '')
      $('#fb_like, #fb_comments').attr('data-href', '{{ url("/rumu/{$roomCode}") }}');
@else

...
<p class="w-100 text-center mt-4">
  <a style="color: white" id="new-board" class="w-25 btn btn-dark btn-lg"><i class="fad fa-save"></i> Lưu bàn cờ</a>
  <a style="color: white" id="undo" class="w-25 btn btn-danger btn-lg"><i class="fad fa-undo"></i> Xếp lại</a>
</p>
@if ($board != '')
...
<div id="copy-url" class="input-group mb-2 w-50 mx-auto" data-toggle="tooltip" data-placement="bottom" data-original-title="Ấn để sao chép">
  ...
  <input type="text" class="form-control" id="url" value="{{ url('/') }}/amp/co-the/{{ $board }}">
</div>
<script>

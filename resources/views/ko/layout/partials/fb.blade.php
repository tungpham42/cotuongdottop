<div style="background-color: #312e2b" class="container-fluid comments px-0">
  <div class="container mx-auto px-0">
    <div class="row w-100 mx-auto p-3">
      <h2 class="mb-4 w-100 text-light"><i class="fas fa-comments"></i> 코멘트</h2>
      <div id="fb-root"></div>
      <script>
      $(document).ready(function() {
        $.ajax({
          url: 'https://connect.facebook.net/ko_KR/sdk.js',
          type: 'GET',
          cache: true,
          global: false,
          dataType: 'script',
      ...
      chatbox.setAttribute("logged_in_greeting", "안녕, 플레이어!");
      chatbox.setAttribute("logged_out_greeting", "우리가 어떻게 도와 드릴까요?");
...
@if ($roomCode != '')
      $('#fb_like, #fb_comments').attr('data-href', '{{ url("/bang/{$roomCode}") }}');
@else

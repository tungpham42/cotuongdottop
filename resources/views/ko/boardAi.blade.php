...
@section('aboveBoard')
<h5 class="text-center my-1" data-toggle="tooltip" data-placement="top" title="게임 기술 향상">너는 컴퓨터로 보드를 풀고 있다.</h5>
@endsection
@section('aboveContent')
<h5 class="text-center my-1">보드 레벨: {{ $levelTxt }}</h5>
<div class="level dropup mx-auto text-center my-1">
  ...
  <div class="dropdown-menu dropdown-menu-right shadow-lg" aria-labelledby="levelDropdown">
    <a class="add-fen dropdown-item{{ $levelTxt === '뉴비' ? ' active disabled' : '' }}" href="{{ url('/nyubi-bodeu') }}" style="cursor: pointer !important;">뉴비</a>
    <a class="add-fen dropdown-item{{ $levelTxt === '쉬운' ? ' active disabled' : '' }}" href="{{ url('/iji-bodeu') }}" style="cursor: pointer !important;">쉬운</a>
    <a class="add-fen dropdown-item{{ $levelTxt === '노멀' ? ' active disabled' : '' }}" href="{{ url('/nomol-bodeu') }}" style="cursor: pointer !important;">노멀</a>
    <a class="add-fen dropdown-item{{ $levelTxt === '하드' ? ' active disabled' : '' }}" href="{{ url('/hadeu-bodeu') }}" style="cursor: pointer !important;">하드</a>
    <a class="add-fen dropdown-item{{ $levelTxt === '가장 단단한' ? ' active disabled' : '' }}" href="{{ url('/gajang-dandanhan-bodeu') }}" style="cursor: pointer !important;">가장 단단한</a>
  </div>
</div>
@endsection
...
<p class="w-100 text-center mt-0 mb-1">
  <a data-step="2" data-intro="단서가 부족한 경우 여기를 클릭하세요" id="resign" class="w-25 btn btn-dark btn-lg"><i class="fad fa-flag"></i> 사직하다</a>
...
<p class="w-100 text-center mt-0 mb-1">
  <a data-step="4" data-intro="친구와 함께 이 보드를 플레이하려면 여기를 클릭하세요" id="board" class="add-fen w-25 btn btn-dark btn-lg" href="{{ url('/bodeu') }}"><i class="fad fa-user"></i> 친구와 플레이</a>
  <a data-step="5" data-intro="처음부터 다시 시작하려면 여기를 클릭하세요" id="reset" class="w-25 btn btn-dark btn-lg"><i class="fad fa-redo-alt"></i> 다시 시작</a>
</p>
<div class="text-center mx-auto" style="width: fit-content;" data-step="7" data-intro="이 페이지를 모바일에서 열어주세요">

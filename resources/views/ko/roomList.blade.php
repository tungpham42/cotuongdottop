...
<div class="container-fluid game px-0">
  <div class="container p-3">
    ...
    <div data-step="2" data-intro="모든 경기 목록" class="table-responsive">
      <table id="danh-sach-phong" class="table table-bordered table-hover table-striped table-sm">
        <thead class="thead-light">
          <tr>
            <th class="text-center" scope="col">방 이름</th>
            <th class="text-center" scope="col">플레이어의 차례</th>
            <th class="text-center" scope="col">결과</th>
            <th class="text-center" scope="col">행위</th>
            <th class="text-center" scope="col">마지막 플레이</th>
          </tr>
        </thead>
  ...
  <div class="modal-dialog modal-dialog-centered" role="document" style="max-width: 320px; margin: auto;">
    <div class="modal-content shadow-lg">
      <div class="modal-header">
        <h5 class="modal-title"><i class="far fa-eye"></i> "<span></span>"의 미리보기</h5>
...
$(document).ready(function () {
  console.log('List URL: ' + '{{ route('roomsKo.list') }}');

...
<p class="w-100 text-center mt-0 mb-1">
  <a data-step="3" data-intro="Click here to play with computer" class="w-25 btn btn-dark btn-lg showPromotion" href="{{ url('/en') }}"><i class="fad fa-desktop"></i> Train with AI</a>

...
@section('aboveBoard')
<h5 class="text-center my-1" data-toggle="tooltip" data-placement="top" title="Playing black">You are invited</h5>
<span id="room-name">Room's name: {{ $room->name }}</span>
@endsection
@section('aboveContent')
<p id="room-code" class="w-100 text-center mt-0 mb-1">
  <span data-step="2" data-intro="Use this room code to search for match" class="alert alert-dark d-inline-block" role="alert" data-toggle="tooltip" data-placement="bottom" data-original-title="Copy this room code"><i class="fad fa-trophy-alt"></i> Room code: <strong style="cursor: pointer;">{{ $roomCode }}</strong></span>
...
<div class="text-center mx-auto" style="width: fit-content;" data-step="2" data-intro="Open this page on mobile">
...
//     if (board.orientation() == 'black' && game.turn() === 'r') {

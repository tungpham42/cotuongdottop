...
@section('aboveBoard')
<h5 class="text-center my-1" data-toggle="tooltip" data-placement="top" title="Viewing two players playing">You are watching</h5>
<span id="room-name">Room's name: {{ $room->name }}</span>
@endsection
@section('aboveContent')
<p id="room-code" class="w-100 text-center mt-0 mb-1">
  <span data-step="1" data-intro="Use this room code to search for match" class="alert alert-dark d-inline-block" role="alert" data-toggle="tooltip" data-placement="bottom" data-original-title="Copy this room code"><i class="fad fa-trophy-alt"></i> Room code: <strong style="cursor: pointer;">{{ $roomCode }}</strong></span>
...
@else
  ...
  <p class="w-100 text-center">
    <span class="text-light lead">Game finished</span>
  </p>
  @endif
@endif

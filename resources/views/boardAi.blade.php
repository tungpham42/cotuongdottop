...
@section('aboveBoard')
<h5 class="text-center my-1" data-toggle="tooltip" data-placement="top" title="Cấp độ máy: {{ $levelTxt }}">Bạn đang giải<span id="puzzle-title"></span> với máy</h5>
@endsection
...
<h5 class="text-center my-1">Cấp độ bàn cờ: {{ $levelTxt }}</h5>
<div class="level dropup mx-auto text-center my-1">
  ...
  <div class="dropdown-menu dropdown-menu-right shadow-lg" aria-labelledby="levelDropdown">
    <a class="add-fen dropdown-item{{ $levelTxt === 'Mới chơi' ? ' active disabled' : '' }}" href="{{ url('/ban-co-moi-choi') }}" style="cursor: pointer !important;">Mới chơi</a>
    <a class="add-fen dropdown-item{{ $levelTxt === 'Dễ' ? ' active disabled' : '' }}" href="{{ url('/ban-co-de') }}" style="cursor: pointer !important;">Dễ</a>
    <a class="add-fen dropdown-item{{ $levelTxt === 'Bình thường' ? ' active disabled' : '' }}" href="{{ url('/ban-co-binh-thuong') }}" style="cursor: pointer !important;">Bình thường</a>
    <a class="add-fen dropdown-item{{ $levelTxt === 'Khó' ? ' active disabled' : '' }}" href="{{ url('/ban-co-kho') }}" style="cursor: pointer !important;">Khó</a>
    <a class="add-fen dropdown-item{{ $levelTxt === 'Khó nhất' ? ' active disabled' : '' }}" href="{{ url('/ban-co-kho-nhat') }}" style="cursor: pointer !important;">Khó nhất</a>
  </div>
</div>
...
<p class="w-100 text-center mt-0 mb-1">
  ...
  <a data-step="5" data-intro="Ấn vào đây để chơi lại từ đầu" id="reset" class="w-25 btn btn-dark btn-lg"><i class="fad fa-redo-alt"></i> Chơi lại</a>
</p>
<script>
let board = null;

<div class="container-fluid about px-0 font-weight-bold text-center py-0">
  <p class="w-100 text-center my-1">
    <a id="share-board" class="w-25 btn btn-dark btn-lg" href="{{ URL::to('/ban-co/') }}"><i class="fad fa-abacus"></i> Giải bàn cờ</a>
  ...
  <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable" role="document">
    <div class="modal-content shadow-lg">
      ...
      <div class="modal-body">
        ...
        <ol>
          <li><u>Chơi một mình:</u> Kì thủ ấn vào nút <a class="animate" target="_blank" href="{{ URL::to('/choi-mot-minh') }}">"Chơi một mình"</a> trên trang chủ và bắt đầu luyện tập một mình. </li>
          <li><u>Luyện với máy:</u> Kì thủ <strong><em>chơi cờ tướng với máy</em></strong> ngay trên trang chủ. Có 5 cấp độ: <a class="animate" target="_blank" href="{{ url('/moi-choi') }}">Mới chơi</a>, <a class="animate" target="_blank" href="{{ url('/de') }}">Dễ</a>, <a class="animate" target="_blank" href="{{ url('/binh-thuong') }}">Bình thường</a>, <a class="animate" target="_blank" href="{{ url('/kho') }}">Khó</a>, và <a class="animate" target="_blank" href="{{ url('/kho-nhat') }}">Khó nhất</a>.</li>
          <li><u>Chơi online:</u> Kì thủ ấn vào nút "Chơi online", mở một phòng mới với Mã phòng bất kỳ và tạo một Mật khẩu chỉ có bạn biết thôi, đồng thời có thể Mời bạn bè vào chơi qua đường link và chia sẻ mật khẩu cho bạn cùng chơi. Kì thủ cũng có thể vào <a class="animate" target="_blank" href="{{ URL::to('/sanh-cho') }}">"Sảnh chờ"</a> để truy cập vào 1 phòng có sẵn. Trong trang này kì thủ có thể lựa chọn Quân Đỏ hoặc Quân Đen. Quân Đỏ đi trước.</li>
          <li><u>Cờ thế:</u> Dành cho các kỳ thủ, người đã biết chơi cờ lão luyện. Kỳ thủ ấn vào nút <a class="animate" target="_blank" href="{{ url('/co-the') }}">"Cờ thế"</a> trên trang chủ, sau đó di chuyển và bày trận theo ý của mình, nhấn nút "Tải bàn cờ thế" và mời bạn bè cùng giải cờ thế. Ngoài ra còn có lựa chọn "Giải cờ thế", kỳ thủ có thể giải cờ với máy.</li>
        </ol>
      </div>

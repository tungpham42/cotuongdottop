...
Route::match(['get', 'post'], '/room/{code}', function($code) {
  ...
  return view('en/roomHost', ['headTitle' => 'Host - Room: '.RoomController::getRoomName($code), 'bodyClass' => 'room', 'randomRoom' => RoomController::getRandomRoom(), 'roomCode' => $code, 'room' => $room, 'cdnUrl' => URL::to(''), 'langViUrl' => '/phong/'.$code, 'langEnUrl' => '/room/'.$code, 'langJaUrl' => '/rumu/'.$code, 'langKoUrl' => '/bang/'.$code, 'langZhUrl' => '/fangjian/'.$code, 'canonicalUrl' => '/room/'.$code, 'puzzles' => PostsController::getPuzzles(), 'fenCodes' => PostsController::getFenCodes(), 'firstPagePuzzles' => PostsController::getFirstPagePuzzles()]);
});
Route::match(['get', 'post'], '/room/{code}/guest', function($code) {
  ...
  return view('en/roomGuest', ['headTitle' => 'Guest - Room: '.RoomController::getRoomName($code), 'bodyClass' => 'room', 'randomRoom' => RoomController::getRandomRoom(), 'roomCode' => $code, 'room' => $room, 'cdnUrl' => URL::to(''), 'langViUrl' => '/phong/'.$code.'/khach', 'langEnUrl' => '/room/'.$code.'/guest', 'langJaUrl' =>  '/rumu/'.$code.'/geesuto', 'langKoUrl' => '/bang/'.$code.'/bangmun', 'langZhUrl' => '/fangjian/'.$code.'/zhuke', 'canonicalUrl' => '/room/'.$code.'/guest', 'puzzles' => PostsController::getPuzzles(), 'fenCodes' => PostsController::getFenCodes(), 'firstPagePuzzles' => PostsController::getFirstPagePuzzles()]);
});
...
Route::match(['get', 'post'], '/room/{code}/watch', function($code) {
  ...
  return view('en/roomWatch', ['headTitle' => 'Watch - Room: '.RoomController::getRoomName($code), 'bodyClass' => 'room', 'randomRoom' => RoomController::getRandomRoom(), 'roomCode' => $code, 'room' => $room, 'cdnUrl' => URL::to(''), 'langViUrl' => '/phong/'.$code.'/theo-doi', 'langEnUrl' => '/room/'.$code.'/watch', 'langJaUrl' => '/rumu/'.$code.'/miru', 'langKoUrl' => '/bang/'.$code.'/boda', 'langZhUrl' => '/fangjian/'.$code.'/kan', 'canonicalUrl' => '/room/'.$code.'/watch', 'puzzles' => PostsController::getPuzzles(), 'fenCodes' => PostsController::getFenCodes(), 'firstPagePuzzles' => PostsController::getFirstPagePuzzles()]);
});
...
Route::match(['get', 'post'], '/room/{code}/black', function($code) {
  ...
  return view('en/roomBlack', ['headTitle' => 'Black side - Room: '.RoomController::getRoomName($code), 'bodyClass' => 'room', 'randomRoom' => RoomController::getRandomRoom(), 'roomCode' => $code, 'room' => $room, 'cdnUrl' => URL::to(''), 'langViUrl' => '/phong/'.$code.'/den', 'langEnUrl' => '/room/'.$code.'/black', 'langJaUrl' => '/rumu/'.$code.'/kuro', 'langKoUrl' => '/bang/'.$code.'/geom-eunsaeg', 'langZhUrl' => '/fangjian/'.$code.'/heise', 'canonicalUrl' => '/room/'.$code.'/black', 'puzzles' => PostsController::getPuzzles(), 'fenCodes' => PostsController::getFenCodes(), 'firstPagePuzzles' => PostsController::getFirstPagePuzzles()]);
});
...
Route::match(['get', 'post'], '/rumu/{code}', function($code) {
  ...
  return view('ja/roomHost', ['headTitle' => 'ホスト - ルーム: '.RoomController::getRoomName($code), 'bodyClass' => 'room', 'randomRoom' => RoomController::getRandomRoom(), 'roomCode' => $code, 'room' => $room, 'cdnUrl' => URL::to(''), 'langViUrl' => '/phong/'.$code, 'langEnUrl' => '/room/'.$code, 'langJaUrl' => '/rumu/'.$code, 'langKoUrl' => '/bang/'.$code, 'langZhUrl' => '/fangjian/'.$code, 'canonicalUrl' => '/rumu/'.$code, 'puzzles' => PostsController::getPuzzles(), 'fenCodes' => PostsController::getFenCodes(), 'firstPagePuzzles' => PostsController::getFirstPagePuzzles()]);
});
Route::match(['get', 'post'], '/rumu/{code}/geesuto', function($code) {
  ...
  return view('ja/roomGuest', ['headTitle' => 'ゲスト - ルーム: '.RoomController::getRoomName($code), 'bodyClass' => 'room', 'randomRoom' => RoomController::getRandomRoom(), 'roomCode' => $code, 'room' => $room, 'cdnUrl' => URL::to(''), 'langViUrl' => '/phong/'.$code.'/khach', 'langEnUrl' => '/room/'.$code.'/guest', 'langJaUrl' =>  '/rumu/'.$code.'/geesuto', 'langKoUrl' => '/bang/'.$code.'/bangmun', 'langZhUrl' => '/fangjian/'.$code.'/zhuke', 'canonicalUrl' => '/rumu/'.$code.'/geesuto', 'puzzles' => PostsController::getPuzzles(), 'fenCodes' => PostsController::getFenCodes(), 'firstPagePuzzles' => PostsController::getFirstPagePuzzles()]);
});
...
Route::match(['get', 'post'], '/rumu/{code}/miru', function($code) {
  ...
  return view('ja/roomWatch', ['headTitle' => '見る - ルーム: '.RoomController::getRoomName($code), 'bodyClass' => 'room', 'randomRoom' => RoomController::getRandomRoom(), 'roomCode' => $code, 'room' => $room, 'cdnUrl' => URL::to(''), 'langViUrl' => '/phong/'.$code.'/theo-doi', 'langEnUrl' => '/room/'.$code.'/watch', 'langJaUrl' => '/rumu/'.$code.'/miru', 'langKoUrl' => '/bang/'.$code.'/boda', 'langZhUrl' => '/fangjian/'.$code.'/kan', 'canonicalUrl' => '/rumu/'.$code.'/miru', 'puzzles' => PostsController::getPuzzles(), 'fenCodes' => PostsController::getFenCodes(), 'firstPagePuzzles' => PostsController::getFirstPagePuzzles()]);
});
...
Route::match(['get', 'post'], '/rumu/{code}/kuro', function($code) {
  ...
  return view('ja/roomBlack', ['headTitle' => '黒 - ルーム: '.RoomController::getRoomName($code), 'bodyClass' => 'room', 'randomRoom' => RoomController::getRandomRoom(), 'roomCode' => $code, 'room' => $room, 'cdnUrl' => URL::to(''), 'langViUrl' => '/phong/'.$code.'/den', 'langEnUrl' => '/room/'.$code.'/black', 'langJaUrl' => '/rumu/'.$code.'/kuro', 'langKoUrl' => '/bang/'.$code.'/geom-eunsaeg', 'langZhUrl' => '/fangjian/'.$code.'/heise', 'canonicalUrl' => '/rumu/'.$code.'/kuro', 'puzzles' => PostsController::getPuzzles(), 'fenCodes' => PostsController::getFenCodes(), 'firstPagePuzzles' => PostsController::getFirstPagePuzzles()]);
});
...
Route::match(['get', 'post'], '/bang/{code}', function($code) {
  ...
  return view('ko/roomHost', ['headTitle' => '주인 - 방: '.RoomController::getRoomName($code), 'bodyClass' => 'room', 'randomRoom' => RoomController::getRandomRoom(), 'roomCode' => $code, 'room' => $room, 'cdnUrl' => URL::to(''), 'langViUrl' => '/phong/'.$code, 'langEnUrl' => '/room/'.$code, 'langJaUrl' => '/rumu/'.$code, 'langKoUrl' => '/bang/'.$code, 'langZhUrl' => '/fangjian/'.$code, 'canonicalUrl' => '/bang/'.$code, 'puzzles' => PostsController::getPuzzles(), 'fenCodes' => PostsController::getFenCodes(), 'firstPagePuzzles' => PostsController::getFirstPagePuzzles()]);
});
Route::match(['get', 'post'], '/bang/{code}/bangmun', function($code) {
  ...
  return view('ko/roomGuest', ['headTitle' => '손님 - 방: '.RoomController::getRoomName($code), 'bodyClass' => 'room', 'randomRoom' => RoomController::getRandomRoom(), 'roomCode' => $code, 'room' => $room, 'cdnUrl' => URL::to(''), 'langViUrl' => '/phong/'.$code.'/khach', 'langEnUrl' => '/room/'.$code.'/guest', 'langJaUrl' =>  '/rumu/'.$code.'/geesuto', 'langKoUrl' => '/bang/'.$code.'/bangmun', 'langZhUrl' => '/fangjian/'.$code.'/zhuke', 'canonicalUrl' => '/bang/'.$code.'/bangmun', 'puzzles' => PostsController::getPuzzles(), 'fenCodes' => PostsController::getFenCodes(), 'firstPagePuzzles' => PostsController::getFirstPagePuzzles()]);
});
...
Route::match(['get', 'post'], '/bang/{code}/geom-eunsaeg', function($code) {
  ...
  return view('ko/roomBlack', ['headTitle' => '검은색 - 방: '.RoomController::getRoomName($code), 'bodyClass' => 'room', 'randomRoom' => RoomController::getRandomRoom(), 'roomCode' => $code, 'room' => $room, 'cdnUrl' => URL::to(''), 'langViUrl' => '/phong/'.$code.'/den', 'langEnUrl' => '/room/'.$code.'/black', 'langJaUrl' => '/rumu/'.$code.'/kuro', 'langKoUrl' => '/bang/'.$code.'/geom-eunsaeg', 'langZhUrl' => '/fangjian/'.$code.'/heise', 'canonicalUrl' => '/bang/'.$code.'/geom-eunsaeg', 'puzzles' => PostsController::getPuzzles(), 'fenCodes' => PostsController::getFenCodes(), 'firstPagePuzzles' => PostsController::getFirstPagePuzzles()]);
});
...
Route::match(['get', 'post'], '/fangjian/{code}', function($code) {
  ...
  return view('zh/roomHost', ['headTitle' => '主办 - 房间：'.RoomController::getRoomName($code), 'bodyClass' => 'room', 'randomRoom' => RoomController::getRandomRoom(), 'roomCode' => $code, 'room' => $room, 'cdnUrl' => URL::to(''), 'langViUrl' => '/phong/'.$code, 'langEnUrl' => '/room/'.$code, 'langJaUrl' => '/rumu/'.$code, 'langKoUrl' => '/bang/'.$code, 'langZhUrl' => '/fangjian/'.$code, 'canonicalUrl' => '/fangjian/'.$code, 'puzzles' => PostsController::getPuzzles(), 'fenCodes' => PostsController::getFenCodes(), 'firstPagePuzzles' => PostsController::getFirstPagePuzzles()]);
});
Route::match(['get', 'post'], '/fangjian/{code}/zhuke', function($code) {
  ...
  return view('zh/roomGuest', ['headTitle' => '客人 - 房间：'.RoomController::getRoomName($code), 'bodyClass' => 'room', 'randomRoom' => RoomController::getRandomRoom(), 'roomCode' => $code, 'room' => $room, 'cdnUrl' => URL::to(''), 'langViUrl' => '/phong/'.$code.'/khach', 'langEnUrl' => '/room/'.$code.'/guest', 'langJaUrl' =>  '/rumu/'.$code.'/geesuto', 'langKoUrl' => '/bang/'.$code.'/bangmun', 'langZhUrl' => '/fangjian/'.$code.'/zhuke', 'canonicalUrl' => '/fangjian/'.$code.'/zhuke', 'puzzles' => PostsController::getPuzzles(), 'fenCodes' => PostsController::getFenCodes(), 'firstPagePuzzles' => PostsController::getFirstPagePuzzles()]);
});
...
Route::match(['get', 'post'], '/fangjian/{code}/heise', function($code) {
  ...
  return view('zh/roomBlack', ['headTitle' => '黑边 - 房间：'.RoomController::getRoomName($code), 'bodyClass' => 'room', 'randomRoom' => RoomController::getRandomRoom(), 'roomCode' => $code, 'room' => $room, 'cdnUrl' => URL::to(''), 'langViUrl' => '/phong/'.$code.'/den', 'langEnUrl' => '/room/'.$code.'/black', 'langJaUrl' => '/rumu/'.$code.'/kuro', 'langKoUrl' => '/bang/'.$code.'/geom-eunsaeg', 'langZhUrl' => '/fangjian/'.$code.'/heise', 'canonicalUrl' => '/fangjian/'.$code.'/heise', 'puzzles' => PostsController::getPuzzles(), 'fenCodes' => PostsController::getFenCodes(), 'firstPagePuzzles' => PostsController::getFirstPagePuzzles()]);
});
...
Route::match(['get', 'post'], '/choi-mot-minh', function () {
  return view('human', ['headTitle' => 'Chơi một mình', 'bodyClass' => 'home', 'randomRoom' => RoomController::getRandomRoom(), 'roomCode' => '', 'cdnUrl' => URL::to(''), 'langViUrl' => '/choi-mot-minh', 'langEnUrl' => '/play-alone', 'langJaUrl' => '/ichi-nin-de-asobu', 'langKoUrl' => '/honja-nolda', 'langZhUrl' => '/duchu', 'canonicalUrl' => '/choi-mot-minh', 'puzzles' => PostsController::getPuzzles(), 'firstPagePuzzles' => PostsController::getFirstPagePuzzles(), 'fenCodes' => PostsController::getFenCodes(), 'books' => PostsController::getBooks(), 'userPuzzles' => PuzzleController::getUserPuzzles(), 'firstUserPuzzles' => PuzzleController::getFirstUserPuzzles(), 'boards' => RoomController::getBoards(), 'firstPageBoards' => RoomController::getFirstPageBoards(), 'playedBoards' => RoomController::getPlayedBoards(), 'firstPagePlayedBoards' => RoomController::getFirstPagePlayedBoards(), 'players' => UserController::getPlayers(), 'firstPagePlayers' => UserController::getFirstPagePlayers()]);
});
Route::match(['get', 'post'], '/play-alone', function () {
  return view('en/human', ['headTitle' => 'Play alone', 'bodyClass' => 'home', 'randomRoom' => RoomController::getRandomRoom(), 'roomCode' => '', 'cdnUrl' => URL::to(''), 'langViUrl' => '/choi-mot-minh', 'langEnUrl' => '/play-alone', 'langJaUrl' => '/ichi-nin-de-asobu', 'langKoUrl' => '/honja-nolda', 'langZhUrl' => '/duchu', 'canonicalUrl' => '/play-alone', 'puzzles' => PostsController::getPuzzles(), 'firstPagePuzzles' => PostsController::getFirstPagePuzzles()]);
});
Route::match(['get', 'post'], '/ichi-nin-de-asobu', function () {
  return view('ja/human', ['headTitle' => '一人で遊ぶ', 'bodyClass' => 'home', 'randomRoom' => RoomController::getRandomRoom(), 'roomCode' => '', 'cdnUrl' => URL::to(''), 'langViUrl' => '/choi-mot-minh', 'langEnUrl' => '/play-alone', 'langJaUrl' => '/ichi-nin-de-asobu', 'langKoUrl' => '/honja-nolda', 'langZhUrl' => '/duchu', 'canonicalUrl' => '/ichi-nin-de-asobu', 'puzzles' => PostsController::getPuzzles(), 'firstPagePuzzles' => PostsController::getFirstPagePuzzles()]);
});
Route::match(['get', 'post'], '/honja-nolda', function () {
  return view('ko/human', ['headTitle' => '혼자 놀다', 'bodyClass' => 'home', 'randomRoom' => RoomController::getRandomRoom(), 'roomCode' => '', 'cdnUrl' => URL::to(''), 'langViUrl' => '/choi-mot-minh', 'langEnUrl' => '/play-alone', 'langJaUrl' => '/ichi-nin-de-asobu', 'langKoUrl' => '/honja-nolda', 'langZhUrl' => '/duchu', 'canonicalUrl' => '/honja-nolda', 'puzzles' => PostsController::getPuzzles(), 'firstPagePuzzles' => PostsController::getFirstPagePuzzles()]);
});
Route::match(['get', 'post'], '/duchu', function () {
  return view('zh/human', ['headTitle' => '独处', 'bodyClass' => 'home', 'randomRoom' => RoomController::getRandomRoom(), 'roomCode' => '', 'cdnUrl' => URL::to(''), 'langViUrl' => '/choi-mot-minh', 'langEnUrl' => '/play-alone', 'langJaUrl' => '/ichi-nin-de-asobu', 'langKoUrl' => '/honja-nolda', 'langZhUrl' => '/duchu', 'canonicalUrl' => '/duchu', 'puzzles' => PostsController::getPuzzles(), 'firstPagePuzzles' => PostsController::getFirstPagePuzzles()]);
});

Route::match(['get', 'post'], '/co-the', function () {
return view('puzzle', ['headTitle' => 'Xếp bàn cờ thế', 'bodyClass' => 'puzzle setup', 'board' => '', 'randomRoom' => RoomController::getRandomRoom(), 'roomCode' => '', 'cdnUrl' => URL::to(''), 'langViUrl' => '/co-the', 'langEnUrl' => '/puzzle', 'langJaUrl' => '/pazuru', 'langKoUrl' => '/peojeul', 'langZhUrl' => '/mi', 'canonicalUrl' => '/co-the', 'puzzles' => PostsController::getPuzzles(), 'firstPagePuzzles' => PostsController::getFirstPagePuzzles(), 'fenCodes' => PostsController::getFenCodes(), 'books' => PostsController::getBooks(), 'userPuzzles' => PuzzleController::getUserPuzzles(), 'firstUserPuzzles' => PuzzleController::getFirstUserPuzzles(), 'boards' => RoomController::getBoards(), 'firstPageBoards' => RoomController::getFirstPageBoards(), 'playedBoards' => RoomController::getPlayedBoards(), 'firstPagePlayedBoards' => RoomController::getFirstPagePlayedBoards(), 'players' => UserController::getPlayers(), 'firstPagePlayers' => UserController::getFirstPagePlayers()]);
});
Route::match(['get', 'post'], '/puzzle', function () {
return view('en/puzzle', ['headTitle' => 'Set up the puzzle', 'bodyClass' => 'puzzle', 'board' => '', 'randomRoom' => RoomController::getRandomRoom(), 'roomCode' => '', 'cdnUrl' => URL::to(''), 'langViUrl' => '/co-the', 'langEnUrl' => '/puzzle', 'langJaUrl' => '/pazuru', 'langKoUrl' => '/peojeul', 'langZhUrl' => '/mi', 'canonicalUrl' => '/puzzle', 'puzzles' => PostsController::getPuzzles(), 'firstPagePuzzles' => PostsController::getFirstPagePuzzles()]);
});
Route::match(['get', 'post'], '/pazuru', function () {
return view('ja/puzzle', ['headTitle' => 'パズルを組み立てる', 'bodyClass' => 'puzzle', 'board' => '', 'randomRoom' => RoomController::getRandomRoom(), 'roomCode' => '', 'cdnUrl' => URL::to(''), 'langViUrl' => '/co-the', 'langEnUrl' => '/puzzle', 'langJaUrl' => '/pazuru', 'langKoUrl' => '/peojeul', 'langZhUrl' => '/mi', 'canonicalUrl' => '/pazuru', 'puzzles' => PostsController::getPuzzles(), 'firstPagePuzzles' => PostsController::getFirstPagePuzzles()]);
});
Route::match(['get', 'post'], '/peojeul', function () {
return view('ko/puzzle', ['headTitle' => '퍼즐', 'bodyClass' => 'puzzle', 'board' => '', 'randomRoom' => RoomController::getRandomRoom(), 'roomCode' => '', 'cdnUrl' => URL::to(''), 'langViUrl' => '/co-the', 'langEnUrl' => '/puzzle', 'langJaUrl' => '/pazuru', 'langKoUrl' => 'peojeul', 'langZhUrl' => '/mi', 'canonicalUrl' => '/peojeul', 'puzzles' => PostsController::getPuzzles(), 'firstPagePuzzles' => PostsController::getFirstPagePuzzles()]);
});
Route::match(['get', 'post'], '/mi', function () {
return view('zh/puzzle', ['headTitle' => '谜', 'bodyClass' => 'puzzle', 'board' => '', 'randomRoom' => RoomController::getRandomRoom(), 'roomCode' => '', 'cdnUrl' => URL::to(''), 'langViUrl' => '/co-the', 'langEnUrl' => '/puzzle', 'langJaUrl' => '/pazuru', 'langKoUrl' => '/peojeul', 'langZhUrl' => '/mi', 'canonicalUrl' => '/mi', 'puzzles' => PostsController::getPuzzles(), 'firstPagePuzzles' => PostsController::getFirstPagePuzzles()]);
});

Route::match(['get', 'post'], '/thach-dau/{board}', function ($board) {
return view('puzzleCompete', ['headTitle' => 'Thách đấu', 'bodyClass' => 'puzzle', 'board' => $board, 'randomRoom' => RoomController::getRandomRoom(), 'roomCode' => '', 'cdnUrl' => URL::to(''), 'langViUrl' => '/', 'langEnUrl' => '/en', 'langJaUrl' => '/ja', 'langKoUrl' => '/ko', 'langZhUrl' => '/zh', 'canonicalUrl' => '/thach-dau/'.$board, 'puzzles' => PostsController::getPuzzles(), 'firstPagePuzzles' => PostsController::getFirstPagePuzzles(), 'fenCodes' => PostsController::getFenCodes(), 'books' => PostsController::getBooks(), 'userPuzzles' => PuzzleController::getUserPuzzles(), 'firstUserPuzzles' => PuzzleController::getFirstUserPuzzles(), 'boards' => RoomController::getBoards(), 'firstPageBoards' => RoomController::getFirstPageBoards(), 'playedBoards' => RoomController::getPlayedBoards(), 'firstPagePlayedBoards' => RoomController::getFirstPagePlayedBoards(), 'players' => UserController::getPlayers(), 'firstPagePlayers' => UserController::getFirstPagePlayers()]);
})->where(['board' => $fenRegex]);

Route::match(['get', 'post'], '/the-co/{slug}', function ($slug) {
return view('puzzleRating', ['headTitle' => 'Thế cờ "'.PuzzleController::getName($slug).'"', 'bodyClass' => 'puzzle', 'name' => PuzzleController::getName($slug), 'slug' => $slug, 'fen' => PuzzleController::getFen($slug) , 'randomRoom' => RoomController::getRandomRoom(), 'roomCode' => '', 'cdnUrl' => URL::to(''), 'langViUrl' => '/', 'langEnUrl' => '/en', 'langJaUrl' => '/ja', 'langKoUrl' => '/ko', 'langZhUrl' => '/zh', 'canonicalUrl' => '/the-co/'.$slug, 'puzzles' => PostsController::getPuzzles(), 'firstPagePuzzles' => PostsController::getFirstPagePuzzles(), 'fenCodes' => PostsController::getFenCodes(), 'books' => PostsController::getBooks(), 'userPuzzles' => PuzzleController::getUserPuzzles(), 'firstUserPuzzles' => PuzzleController::getFirstUserPuzzles(), 'boards' => RoomController::getBoards(), 'firstPageBoards' => RoomController::getFirstPageBoards(), 'playedBoards' => RoomController::getPlayedBoards(), 'firstPagePlayedBoards' => RoomController::getFirstPagePlayedBoards(), 'players' => UserController::getPlayers(), 'firstPagePlayers' => UserController::getFirstPagePlayers()]);
});
...
return view('puzzle', ['headTitle' => 'Bàn cờ thế'.PostsController::getPuzzleTitle($board), 'bodyClass' => 'puzzle', 'board' => $board, 'randomRoom' => RoomController::getRandomRoom(), 'roomCode' => '', 'cdnUrl' => URL::to(''), 'langViUrl' => '/co-the/'.$board, 'langEnUrl' => '/puzzle/'.$board, 'langJaUrl' => '/pazuru/'.$board, 'langKoUrl' => '/peojeul/'.$board, 'langZhUrl' => '/mi/'.$board, 'canonicalUrl' => '/co-the/'.$board, 'puzzles' => PostsController::getPuzzles(), 'firstPagePuzzles' => PostsController::getFirstPagePuzzles(), 'fenCodes' => PostsController::getFenCodes(), 'books' => PostsController::getBooks(), 'userPuzzles' => PuzzleController::getUserPuzzles(), 'firstUserPuzzles' => PuzzleController::getFirstUserPuzzles(), 'boards' => RoomController::getBoards(), 'firstPageBoards' => RoomController::getFirstPageBoards(), 'playedBoards' => RoomController::getPlayedBoards(), 'firstPagePlayedBoards' => RoomController::getFirstPagePlayedBoards(), 'players' => UserController::getPlayers(), 'firstPagePlayers' => UserController::getFirstPagePlayers()]);
})->where(['board' => $fenRegex]);
Route::match(['get', 'post'], '/puzzle/{board}', function ($board) {
return view('en/puzzle', ['headTitle' => 'Puzzle', 'bodyClass' => 'puzzle', 'board' => $board, 'randomRoom' => RoomController::getRandomRoom(), 'roomCode' => '', 'cdnUrl' => URL::to(''), 'langViUrl' => '/co-the/'.$board, 'langEnUrl' => '/puzzle/'.$board, 'langJaUrl' => '/pazuru/'.$board, 'langKoUrl' => '/peojeul/'.$board, 'langZhUrl' => '/mi/'.$board, 'canonicalUrl' => '/puzzle/'.$board, 'puzzles' => PostsController::getPuzzles(), 'firstPagePuzzles' => PostsController::getFirstPagePuzzles()]);
})->where(['board' => $fenRegex]);
Route::match(['get', 'post'], '/pazuru/{board}', function ($board) {
return view('ja/puzzle', ['headTitle' => 'パズル', 'bodyClass' => 'puzzle', 'board' => $board, 'randomRoom' => RoomController::getRandomRoom(), 'roomCode' => '', 'cdnUrl' => URL::to(''), 'langViUrl' => '/co-the/'.$board, 'langEnUrl' => '/puzzle/'.$board, 'langJaUrl' => '/pazuru/'.$board, 'langKoUrl' => '/peojeul/'.$board, 'langZhUrl' => '/mi/'.$board, 'canonicalUrl' => '/pazuru/'.$board, 'puzzles' => PostsController::getPuzzles(), 'firstPagePuzzles' => PostsController::getFirstPagePuzzles()]);
})->where(['board' => $fenRegex]);
Route::match(['get', 'post'], '/peojeul/{board}', function ($board) {
return view('ko/puzzle', ['headTitle' => '퍼즐', 'bodyClass' => 'puzzle', 'board' => $board, 'randomRoom' => RoomController::getRandomRoom(), 'roomCode' => '', 'cdnUrl' => URL::to(''), 'langViUrl' => '/co-the/'.$board, 'langEnUrl' => '/puzzle/'.$board, 'langJaUrl' => '/pazuru/'.$board, 'langKoUrl' => '/peojeul/'.$board, 'langZhUrl' => '/mi/'.$board, 'canonicalUrl' => '/peojeul/'.$board, 'puzzles' => PostsController::getPuzzles(), 'firstPagePuzzles' => PostsController::getFirstPagePuzzles()]);
})->where(['board' => $fenRegex]);
Route::match(['get', 'post'], '/mi/{board}', function ($board) {
return view('zh/puzzle', ['headTitle' => '谜', 'bodyClass' => 'puzzle', 'board' => $board, 'randomRoom' => RoomController::getRandomRoom(), 'roomCode' => '', 'cdnUrl' => URL::to(''), 'langViUrl' => '/co-the/'.$board, 'langEnUrl' => '/puzzle/'.$board, 'langJaUrl' => '/pazuru/'.$board, 'langKoUrl' => '/peojeul/'.$board, 'langZhUrl' => '/mi/'.$board, 'canonicalUrl' => '/mi/'.$board, 'puzzles' => PostsController::getPuzzles(), 'firstPagePuzzles' => PostsController::getFirstPagePuzzles()]);
})->where(['board' => $fenRegex]);

Route::match(['get', 'post'], '/ban-co/{fen}', function ($fen) {
return view('board', ['headTitle' => 'Bàn cờ tự giải'.PostsController::getPuzzleTitle($fen), 'bodyClass' => 'home', 'fen' => $fen, 'randomRoom' => RoomController::getRandomRoom(), 'roomCode' => '', 'cdnUrl' => URL::to(''), 'langViUrl' => '/ban-co/'.$fen, 'langEnUrl' => '/board/'.$fen, 'langJaUrl' => '/bodo/'.$fen, 'langKoUrl' => '/bodeu/'.$fen, 'langZhUrl' => '/ban/'.$fen, 'canonicalUrl' => '/ban-co/'.$fen, 'puzzles' => PostsController::getPuzzles(), 'firstPagePuzzles' => PostsController::getFirstPagePuzzles(), 'fenCodes' => PostsController::getFenCodes(), 'books' => PostsController::getBooks(), 'userPuzzles' => PuzzleController::getUserPuzzles(), 'firstUserPuzzles' => PuzzleController::getFirstUserPuzzles(), 'boards' => RoomController::getBoards(), 'firstPageBoards' => RoomController::getFirstPageBoards(), 'playedBoards' => RoomController::getPlayedBoards(), 'firstPagePlayedBoards' => RoomController::getFirstPagePlayedBoards(), 'players' => UserController::getPlayers(), 'firstPagePlayers' => UserController::getFirstPagePlayers()]);
})->where(['fen' => $fenRegex]);

Route::match(['get', 'post'], '/ban-co-de-nhat/{fen}', function ($fen) {
return view('boardAi', ['headTitle' => 'Bàn cờ dễ nhất'.PostsController::getPuzzleTitle($fen), 'bodyClass' => 'home', 'fen' => $fen, 'randomRoom' => RoomController::getRandomRoom(), 'roomCode' => '', 'level' => '1', 'levelTxt' => 'Dễ nhất', 'cdnUrl' => URL::to(''), 'langViUrl' => '/ban-co-de-nhat/'.$fen, 'langEnUrl' => '/easiest-board/'.$fen, 'langJaUrl' => '/mottomo-kantanna-bodo/'.$fen, 'langKoUrl' => '/gajang-swiun-bodeu/'.$fen, 'langZhUrl' => '/zuijiandandeban/'.$fen, 'canonicalUrl' => '/ban-co-de-nhat/'.$fen, 'puzzles' => PostsController::getPuzzles(), 'firstPagePuzzles' => PostsController::getFirstPagePuzzles(), 'fenCodes' => PostsController::getFenCodes(), 'books' => PostsController::getBooks(), 'userPuzzles' => PuzzleController::getUserPuzzles(), 'firstUserPuzzles' => PuzzleController::getFirstUserPuzzles(), 'boards' => RoomController::getBoards(), 'firstPageBoards' => RoomController::getFirstPageBoards(), 'playedBoards' => RoomController::getPlayedBoards(), 'firstPagePlayedBoards' => RoomController::getFirstPagePlayedBoards(), 'players' => UserController::getPlayers(), 'firstPagePlayers' => UserController::getFirstPagePlayers()]);
})->where(['fen' => $fenRegex]);
Route::match(['get', 'post'], '/ban-co-moi-choi/{fen}', function ($fen) {
return view('boardAi', ['headTitle' => 'Bàn cờ mới chơi'.PostsController::getPuzzleTitle($fen), 'bodyClass' => 'home', 'fen' => $fen, 'randomRoom' => RoomController::getRandomRoom(), 'roomCode' => '', 'level' => '1', 'levelTxt' => 'Mới chơi', 'cdnUrl' => URL::to(''), 'langViUrl' => '/ban-co-moi-choi/'.$fen, 'langEnUrl' => '/newbie-board/'.$fen, 'langJaUrl' => '/shoshinsha-bodo/'.$fen, 'langKoUrl' => '/nyubi-bodeu/'.$fen, 'langZhUrl' => '/xinshouban/'.$fen, 'canonicalUrl' => '/ban-co-moi-choi/'.$fen, 'puzzles' => PostsController::getPuzzles(), 'firstPagePuzzles' => PostsController::getFirstPagePuzzles(), 'fenCodes' => PostsController::getFenCodes(), 'books' => PostsController::getBooks(), 'userPuzzles' => PuzzleController::getUserPuzzles(), 'firstUserPuzzles' => PuzzleController::getFirstUserPuzzles(), 'boards' => RoomController::getBoards(), 'firstPageBoards' => RoomController::getFirstPageBoards(), 'playedBoards' => RoomController::getPlayedBoards(), 'firstPagePlayedBoards' => RoomController::getFirstPagePlayedBoards(), 'players' => UserController::getPlayers(), 'firstPagePlayers' => UserController::getFirstPagePlayers()]);
})->where(['fen' => $fenRegex]);
Route::match(['get', 'post'], '/ban-co-de/{fen}', function ($fen) {
return view('boardAi', ['headTitle' => 'Bàn cờ dễ'.PostsController::getPuzzleTitle($fen), 'bodyClass' => 'home', 'fen' => $fen, 'randomRoom' => RoomController::getRandomRoom(), 'roomCode' => '', 'level' => '2', 'levelTxt' => 'Dễ', 'cdnUrl' => URL::to(''), 'langViUrl' => '/ban-co-de/'.$fen, 'langEnUrl' => '/easy-board/'.$fen, 'langJaUrl' => '/kantan-bodo/'.$fen, 'langKoUrl' => '/iji-bodeu/'.$fen, 'langZhUrl' => '/jianyiban/'.$fen, 'canonicalUrl' => '/ban-co-de/'.$fen, 'puzzles' => PostsController::getPuzzles(), 'firstPagePuzzles' => PostsController::getFirstPagePuzzles(), 'fenCodes' => PostsController::getFenCodes(), 'books' => PostsController::getBooks(), 'userPuzzles' => PuzzleController::getUserPuzzles(), 'firstUserPuzzles' => PuzzleController::getFirstUserPuzzles(), 'boards' => RoomController::getBoards(), 'firstPageBoards' => RoomController::getFirstPageBoards(), 'playedBoards' => RoomController::getPlayedBoards(), 'firstPagePlayedBoards' => RoomController::getFirstPagePlayedBoards(), 'players' => UserController::getPlayers(), 'firstPagePlayers' => UserController::getFirstPagePlayers()]);
})->where(['fen' => $fenRegex]);
Route::match(['get', 'post'], '/ban-co-binh-thuong/{fen}', function ($fen) {
return view('boardAi', ['headTitle' => 'Bàn cờ bình thường'.PostsController::getPuzzleTitle($fen), 'bodyClass' => 'home', 'fen' => $fen, 'randomRoom' => RoomController::getRandomRoom(), 'roomCode' => '', 'level' => '3', 'levelTxt' => 'Bình thường', 'cdnUrl' => URL::to(''), 'langViUrl' => '/ban-co-binh-thuong/'.$fen, 'langEnUrl' => '/normal-board/'.$fen, 'langJaUrl' => '/tsujo-bodo/'.$fen, 'langKoUrl' => '/nomol-bodeu/'.$fen, 'langZhUrl' => '/putongban/'.$fen, 'canonicalUrl' => '/ban-co-binh-thuong/'.$fen, 'puzzles' => PostsController::getPuzzles(), 'firstPagePuzzles' => PostsController::getFirstPagePuzzles(), 'fenCodes' => PostsController::getFenCodes(), 'books' => PostsController::getBooks(), 'userPuzzles' => PuzzleController::getUserPuzzles(), 'firstUserPuzzles' => PuzzleController::getFirstUserPuzzles(), 'boards' => RoomController::getBoards(), 'firstPageBoards' => RoomController::getFirstPageBoards(), 'playedBoards' => RoomController::getPlayedBoards(), 'firstPagePlayedBoards' => RoomController::getFirstPagePlayedBoards(), 'players' => UserController::getPlayers(), 'firstPagePlayers' => UserController::getFirstPagePlayers()]);
})->where(['fen' => $fenRegex]);
Route::match(['get', 'post'], '/ban-co-kho/{fen}', function ($fen) {
return view('boardAi', ['headTitle' => 'Bàn cờ khó'.PostsController::getPuzzleTitle($fen), 'bodyClass' => 'home', 'fen' => $fen, 'randomRoom' => RoomController::getRandomRoom(), 'roomCode' => '', 'level' => '4', 'levelTxt' => 'Khó', 'cdnUrl' => URL::to(''), 'langViUrl' => '/ban-co-kho/'.$fen, 'langEnUrl' => '/hard-board/'.$fen, 'langJaUrl' => '/hado-bodo/'.$fen, 'langKoUrl' => '/hadeu-bodeu/'.$fen, 'langZhUrl' => '/yingban/'.$fen, 'canonicalUrl' => '/ban-co-kho/'.$fen]);
})->where(['fen' => $fenRegex]);
Route::match(['get', 'post'], '/ban-co-kho-nhat/{fen}', function ($fen) {
return view('boardAi', ['headTitle' => 'Bàn cờ khó nhất'.PostsController::getPuzzleTitle($fen), 'bodyClass' => 'home', 'fen' => $fen, 'randomRoom' => RoomController::getRandomRoom(), 'roomCode' => '', 'level' => '4', 'levelTxt' => 'Khó nhất', 'cdnUrl' => URL::to(''), 'langViUrl' => '/ban-co-kho-nhat/'.$fen, 'langEnUrl' => '/hardest-board/'.$fen, 'langJaUrl' => '/mottomo-muzukashi-bodo/'.$fen, 'langKoUrl' => '/gajang-dandanhan-bodeu/'.$fen, 'langZhUrl' => '/zuiyingban/'.$fen, 'canonicalUrl' => '/ban-co-kho-nhat/'.$fen, 'puzzles' => PostsController::getPuzzles(), 'firstPagePuzzles' => PostsController::getFirstPagePuzzles(), 'fenCodes' => PostsController::getFenCodes(), 'books' => PostsController::getBooks(), 'userPuzzles' => PuzzleController::getUserPuzzles(), 'firstUserPuzzles' => PuzzleController::getFirstUserPuzzles(), 'boards' => RoomController::getBoards(), 'firstPageBoards' => RoomController::getFirstPageBoards(), 'playedBoards' => RoomController::getPlayedBoards(), 'firstPagePlayedBoards' => RoomController::getFirstPagePlayedBoards(), 'players' => UserController::getPlayers(), 'firstPagePlayers' => UserController::getFirstPagePlayers()]);
})->where(['fen' => $fenRegex]);
Route::match(['get', 'post'], '/giai-co-the/{fen}', function ($fen) {
return view('puzzleAi', ['headTitle' => 'Giải cờ thế'.PostsController::getPuzzleTitle($fen), 'bodyClass' => 'puzzle', 'fen' => $fen, 'randomRoom' => RoomController::getRandomRoom(), 'roomCode' => '', 'level' => '4', 'levelTxt' => 'Khó nhất', 'cdnUrl' => URL::to(''), 'langViUrl' => '/giai-co-the/'.$fen, 'langEnUrl' => '/solve-puzzle/'.$fen, 'langJaUrl' => '/pazuru-o-toku/'.$fen, 'langKoUrl' => '/pojeureul-pulda/'.$fen, 'langZhUrl' => '/jiejuenanti/'.$fen, 'canonicalUrl' => '/giai-co-the/'.$fen, 'puzzles' => PostsController::getPuzzles(), 'firstPagePuzzles' => PostsController::getFirstPagePuzzles(), 'fenCodes' => PostsController::getFenCodes(), 'books' => PostsController::getBooks(), 'userPuzzles' => PuzzleController::getUserPuzzles(), 'firstUserPuzzles' => PuzzleController::getFirstUserPuzzles(), 'boards' => RoomController::getBoards(), 'firstPageBoards' => RoomController::getFirstPageBoards(), 'playedBoards' => RoomController::getPlayedBoards(), 'firstPagePlayedBoards' => RoomController::getFirstPagePlayedBoards(), 'players' => UserController::getPlayers(), 'firstPagePlayers' => UserController::getFirstPagePlayers()]);
})->where(['fen' => $fenRegex]);

Route::match(['get', 'post'], '/board/{fen}', function ($fen) {
  return view('en/board', ['headTitle' => 'Board', 'bodyClass' => 'home', 'fen' => $fen, 'randomRoom' => RoomController::getRandomRoom(), 'roomCode' => '', 'cdnUrl' => URL::to(''), 'langViUrl' => '/ban-co/'.$fen, 'langEnUrl' => '/board/'.$fen, 'langJaUrl' => '/bodo/'.$fen, 'langKoUrl' => '/bodeu/'.$fen, 'langZhUrl' => '/ban/'.$fen, 'canonicalUrl' => '/board/'.$fen, 'puzzles' => PostsController::getPuzzles(), 'firstPagePuzzles' => PostsController::getFirstPagePuzzles()]);
})->where(['fen' => $fenRegex]);

Route::match(['get', 'post'], '/easiest-board/{fen}', function ($fen) {
return view('en/boardAi', ['headTitle' => 'Easiest board', 'bodyClass' => 'home', 'fen' => $fen, 'randomRoom' => RoomController::getRandomRoom(), 'roomCode' => '', 'level' => '1', 'levelTxt' => 'Easiest', 'cdnUrl' => URL::to(''), 'langViUrl' => '/ban-co-de-nhat/'.$fen, 'langEnUrl' => '/easiest-board/'.$fen, 'langJaUrl' => '/mottomo-kantanna-bodo/'.$fen, 'langKoUrl' => '/gajang-swiun-bodeu/'.$fen, 'langZhUrl' => '/zuijiandandeban/'.$fen, 'canonicalUrl' => '/easiest-board/'.$fen, 'puzzles' => PostsController::getPuzzles(), 'firstPagePuzzles' => PostsController::getFirstPagePuzzles()]);
})->where(['fen' => $fenRegex]);
Route::match(['get', 'post'], '/newbie-board/{fen}', function ($fen) {
return view('en/boardAi', ['headTitle' => 'Newbie board', 'bodyClass' => 'home', 'fen' => $fen, 'randomRoom' => RoomController::getRandomRoom(), 'roomCode' => '', 'level' => '1', 'levelTxt' => 'Newbie', 'cdnUrl' => URL::to(''), 'langViUrl' => '/ban-co-moi-choi/'.$fen, 'langEnUrl' => '/newbie-board/'.$fen, 'langJaUrl' => '/shoshinsha-bodo/'.$fen, 'langKoUrl' => '/nyubi-bodeu/'.$fen, 'langZhUrl' => '/xinshouban/'.$fen, 'canonicalUrl' => '/newbie-board/'.$fen, 'puzzles' => PostsController::getPuzzles(), 'firstPagePuzzles' => PostsController::getFirstPagePuzzles()]);
})->where(['fen' => $fenRegex]);
Route::match(['get', 'post'], '/easy-board/{fen}', function ($fen) {
return view('en/boardAi', ['headTitle' => 'Easy board', 'bodyClass' => 'home', 'fen' => $fen, 'randomRoom' => RoomController::getRandomRoom(), 'roomCode' => '', 'level' => '2', 'levelTxt' => 'Easy', 'cdnUrl' => URL::to(''), 'langViUrl' => '/ban-co-de/'.$fen, 'langEnUrl' => '/easy-board/'.$fen, 'langJaUrl' => '/kantan-bodo/'.$fen, 'langKoUrl' => '/iji-bodeu/'.$fen, 'langZhUrl' => '/jianyiban/'.$fen, 'canonicalUrl' => '/easy-board/'.$fen, 'puzzles' => PostsController::getPuzzles(), 'firstPagePuzzles' => PostsController::getFirstPagePuzzles()]);
})->where(['fen' => $fenRegex]);
Route::match(['get', 'post'], '/normal-board/{fen}', function ($fen) {
return view('en/boardAi', ['headTitle' => 'Normal board', 'bodyClass' => 'home', 'fen' => $fen, 'randomRoom' => RoomController::getRandomRoom(), 'roomCode' => '', 'level' => '3', 'levelTxt' => 'Normal', 'cdnUrl' => URL::to(''), 'langViUrl' => '/ban-co-binh-thuong/'.$fen, 'langEnUrl' => '/normal-board/'.$fen, 'langJaUrl' => '/tsujo-bodo/'.$fen, 'langKoUrl' => '/nomol-bodeu/'.$fen, 'langZhUrl' => '/putongban/'.$fen, 'canonicalUrl' => '/normal-board/'.$fen, 'puzzles' => PostsController::getPuzzles(), 'firstPagePuzzles' => PostsController::getFirstPagePuzzles()]);
})->where(['fen' => $fenRegex]);
Route::match(['get', 'post'], '/hard-board/{fen}', function ($fen) {
return view('en/boardAi', ['headTitle' => 'Hard board', 'bodyClass' => 'home', 'fen' => $fen, 'randomRoom' => RoomController::getRandomRoom(), 'roomCode' => '', 'level' => '4', 'levelTxt' => 'Hard', 'cdnUrl' => URL::to(''), 'langViUrl' => '/ban-co-kho/'.$fen, 'langEnUrl' => '/hard-board/'.$fen, 'langJaUrl' => '/hado-bodo/'.$fen, 'langKoUrl' => '/hadeu-bodeu/'.$fen, 'langZhUrl' => '/yingban/'.$fen, 'canonicalUrl' => '/hard-board/'.$fen, 'puzzles' => PostsController::getPuzzles(), 'firstPagePuzzles' => PostsController::getFirstPagePuzzles()]);
})->where(['fen' => $fenRegex]);
Route::match(['get', 'post'], '/hardest-board/{fen}', function ($fen) {
return view('en/boardAi', ['headTitle' => 'Hardest board', 'bodyClass' => 'home', 'fen' => $fen, 'randomRoom' => RoomController::getRandomRoom(), 'roomCode' => '', 'level' => '4', 'levelTxt' => 'Hardest', 'cdnUrl' => URL::to(''), 'langViUrl' => '/ban-co-kho-nhat/'.$fen, 'langEnUrl' => '/hardest-board/'.$fen, 'langJaUrl' => '/mottomo-muzukashi-bodo/'.$fen, 'langKoUrl' => '/gajang-dandanhan-bodeu/'.$fen, 'langZhUrl' => '/zuiyingban/'.$fen, 'canonicalUrl' => '/hardest-board/'.$fen, 'puzzles' => PostsController::getPuzzles(), 'firstPagePuzzles' => PostsController::getFirstPagePuzzles()]);
})->where(['fen' => $fenRegex]);
Route::match(['get', 'post'], '/solve-puzzle/{fen}', function ($fen) {
return view('en/puzzleAi', ['headTitle' => 'Solve puzzle', 'bodyClass' => 'puzzle', 'fen' => $fen, 'randomRoom' => RoomController::getRandomRoom(), 'roomCode' => '', 'level' => '4', 'levelTxt' => 'Hardest', 'cdnUrl' => URL::to(''), 'langViUrl' => '/giai-co-the/'.$fen, 'langEnUrl' => '/solve-puzzle/'.$fen, 'langJaUrl' => '/pazuru-o-toku/'.$fen, 'langKoUrl' => '/pojeureul-pulda/'.$fen, 'langZhUrl' => '/jiejuenanti/'.$fen, 'canonicalUrl' => '/solve-puzzle/'.$fen, 'puzzles' => PostsController::getPuzzles(), 'firstPagePuzzles' => PostsController::getFirstPagePuzzles()]);
})->where(['fen' => $fenRegex]);

Route::match(['get', 'post'], '/bodo/{fen}', function ($fen) {
  return view('ja/board', ['headTitle' => 'ボード', 'bodyClass' => 'home', 'fen' => $fen, 'randomRoom' => RoomController::getRandomRoom(), 'roomCode' => '', 'cdnUrl' => URL::to(''), 'langViUrl' => '/ban-co/'.$fen, 'langEnUrl' => '/board/'.$fen, 'langJaUrl' => '/bodo/'.$fen, 'langKoUrl' => '/bodeu/'.$fen, 'langZhUrl' => '/ban/'.$fen, 'canonicalUrl' => '/bodo/'.$fen, 'puzzles' => PostsController::getPuzzles(), 'firstPagePuzzles' => PostsController::getFirstPagePuzzles()]);
})->where(['fen' => $fenRegex]);
...
return view('ja/boardAi', ['headTitle' => 'イージーボード', 'bodyClass' => 'home', 'fen' => $fen, 'randomRoom' => RoomController::getRandomRoom(), 'roomCode' => '', 'level' => '2', 'levelTxt' => '簡単', 'cdnUrl' => URL::to(''), 'langViUrl' => '/ban-co-de/'.$fen, 'langEnUrl' => '/easy-board/'.$fen, 'langJaUrl' => '/kantan-bodo/'.$fen, 'langKoUrl' => '/iji-bodeu/'.$fen, 'langZhUrl' => '/jianyiban/'.$fen, 'canonicalUrl' => '/kantan-bodo/'.$fen, 'puzzles' => PostsController::getPuzzles(), 'firstPagePuzzles' => PostsController::getFirstPagePuzzles()]);
})->where(['fen' => $fenRegex]);
...
return view('ja/puzzleAi', ['headTitle' => 'パズルを解く', 'bodyClass' => 'puzzle', 'fen' => $fen, 'randomRoom' => RoomController::getRandomRoom(), 'roomCode' => '', 'level' => '4', 'levelTxt' => '最も難しい', 'cdnUrl' => URL::to(''), 'langViUrl' => '/giai-co-the/'.$fen, 'langEnUrl' => '/solve-puzzle/'.$fen, 'langJaUrl' => '/pazuru-o-toku/'.$fen, 'langKoUrl' => '/pojeureul-pulda/'.$fen, 'langZhUrl' => '/jiejuenanti/'.$fen, 'canonicalUrl' => '/pazuru-o-toku/'.$fen, 'puzzles' => PostsController::getPuzzles(), 'firstPagePuzzles' => PostsController::getFirstPagePuzzles()]);
})->where(['fen' => $fenRegex]);

Route::match(['get', 'post'], '/bodeu/{fen}', function ($fen) {
return view('ko/board', ['headTitle' => '보드', 'bodyClass' => 'home', 'fen' => $fen, 'randomRoom' => RoomController::getRandomRoom(), 'roomCode' => '', 'cdnUrl' => URL::to(''), 'langViUrl' => '/ban-co/'.$fen, 'langEnUrl' => '/board/'.$fen, 'langJaUrl' => '/bodo/'.$fen, 'langKoUrl' => '/bodeu/'.$fen, 'langZhUrl' => '/ban/'.$fen, 'canonicalUrl' => '/bodeu/'.$fen, 'puzzles' => PostsController::getPuzzles(), 'firstPagePuzzles' => PostsController::getFirstPagePuzzles()]);
})->where(['fen' => $fenRegex]);

Route::match(['get', 'post'], '/gajang-swiun-bodeu/{fen}', function ($fen) {
return view('ko/boardAi', ['headTitle' => '가장 쉬운 보드', 'bodyClass' => 'home', 'fen' => $fen, 'randomRoom' => RoomController::getRandomRoom(), 'roomCode' => '', 'level' => '1', 'levelTxt' => '가장 쉬운', 'cdnUrl' => URL::to(''), 'langViUrl' => '/ban-co-de-nhat/'.$fen, 'langEnUrl' => '/easiest-board/'.$fen, 'langJaUrl' => '/mottomo-kantanna-bodo/'.$fen, 'langKoUrl' => '/gajang-swiun-bodeu/'.$fen, 'langZhUrl' => '/zuijiandandeban/'.$fen, 'canonicalUrl' => '/gajang-swiun-bodeu/'.$fen, 'puzzles' => PostsController::getPuzzles(), 'firstPagePuzzles' => PostsController::getFirstPagePuzzles()]);
})->where(['fen' => $fenRegex]);
Route::match(['get', 'post'], '/nyubi-bodeu/{fen}', function ($fen) {
return view('ko/boardAi', ['headTitle' => '뉴비 보드', 'bodyClass' => 'home', 'fen' => $fen, 'randomRoom' => RoomController::getRandomRoom(), 'roomCode' => '', 'level' => '1', 'levelTxt' => '뉴비', 'cdnUrl' => URL::to(''), 'langViUrl' => '/ban-co-moi-choi/'.$fen, 'langEnUrl' => '/newbie-board/'.$fen, 'langJaUrl' => '/shoshinsha-bodo/'.$fen, 'langKoUrl' => '/nyubi-bodeu/'.$fen, 'langZhUrl' => '/xinshouban/'.$fen, 'canonicalUrl' => '/nyubi-bodeu/'.$fen, 'puzzles' => PostsController::getPuzzles(), 'firstPagePuzzles' => PostsController::getFirstPagePuzzles()]);
})->where(['fen' => $fenRegex]);
Route::match(['get', 'post'], '/iji-bodeu/{fen}', function ($fen) {
return view('ko/boardAi', ['headTitle' => '이지보드', 'bodyClass' => 'home', 'fen' => $fen, 'randomRoom' => RoomController::getRandomRoom(), 'roomCode' => '', 'level' => '2', 'levelTxt' => '쉬운', 'cdnUrl' => URL::to(''), 'langViUrl' => '/ban-co-de/'.$fen, 'langEnUrl' => '/easy-board/'.$fen, 'langJaUrl' => '/kantan-bodo/'.$fen, 'langKoUrl' => '/iji-bodeu/'.$fen, 'langZhUrl' => '/jianyiban/'.$fen, 'canonicalUrl' => '/iji-bodeu/'.$fen, 'puzzles' => PostsController::getPuzzles(), 'firstPagePuzzles' => PostsController::getFirstPagePuzzles()]);
})->where(['fen' => $fenRegex]);
Route::match(['get', 'post'], '/nomol-bodeu/{fen}', function ($fen) {
return view('ko/boardAi', ['headTitle' => '노멀 보드', 'bodyClass' => 'home', 'fen' => $fen, 'randomRoom' => RoomController::getRandomRoom(), 'roomCode' => '', 'level' => '3', 'levelTxt' => '노멀', 'cdnUrl' => URL::to(''), 'langViUrl' => '/ban-co-binh-thuong/'.$fen, 'langEnUrl' => '/normal-board/'.$fen, 'langJaUrl' => '/tsujo-bodo/'.$fen, 'langKoUrl' => '/nomol-bodeu/'.$fen, 'langZhUrl' => '/putongban/'.$fen, 'canonicalUrl' => '/nomol-bodeu/'.$fen, 'puzzles' => PostsController::getPuzzles(), 'firstPagePuzzles' => PostsController::getFirstPagePuzzles()]);
})->where(['fen' => $fenRegex]);
Route::match(['get', 'post'], '/hadeu-bodeu/{fen}', function ($fen) {
return view('ko/boardAi', ['headTitle' => '하드보드', 'bodyClass' => 'home', 'fen' => $fen, 'randomRoom' => RoomController::getRandomRoom(), 'roomCode' => '', 'level' => '4', 'levelTxt' => '하드', 'cdnUrl' => URL::to(''), 'langViUrl' => '/ban-co-kho/'.$fen, 'langEnUrl' => '/hard-board/'.$fen, 'langJaUrl' => '/hado-bodo/'.$fen, 'langKoUrl' => '/hadeu-bodeu/'.$fen, 'langZhUrl' => '/yingban/'.$fen, 'canonicalUrl' => '/hadeu-bodeu/'.$fen, 'puzzles' => PostsController::getPuzzles(), 'firstPagePuzzles' => PostsController::getFirstPagePuzzles()]);
})->where(['fen' => $fenRegex]);
Route::match(['get', 'post'], '/gajang-dandanhan-bodeu/{fen}', function ($fen) {
return view('ko/boardAi', ['headTitle' => '가장 단단한 보드', 'bodyClass' => 'home', 'fen' => $fen, 'randomRoom' => RoomController::getRandomRoom(), 'roomCode' => '', 'level' => '4', 'levelTxt' => '가장 단단한', 'cdnUrl' => URL::to(''), 'langViUrl' => '/ban-co-kho-nhat/'.$fen, 'langEnUrl' => '/hardest-board/'.$fen, 'langJaUrl' => '/mottomo-muzukashi-bodo/'.$fen, 'langKoUrl' => '/gajang-dandanhan-bodeu/'.$fen, 'langZhUrl' => '/zuiyingban/'.$fen, 'canonicalUrl' => '/gajang-dandanhan-bodeu/'.$fen, 'puzzles' => PostsController::getPuzzles(), 'firstPagePuzzles' => PostsController::getFirstPagePuzzles()]);
})->where(['fen' => $fenRegex]);
Route::match(['get', 'post'], '/pojeureul-pulda/{fen}', function ($fen) {
return view('ko/puzzleAi', ['headTitle' => '퍼즐을 풀다', 'bodyClass' => 'puzzle', 'fen' => $fen, 'randomRoom' => RoomController::getRandomRoom(), 'roomCode' => '', 'level' => '4', 'levelTxt' => '가장 단단한', 'cdnUrl' => URL::to(''), 'langViUrl' => '/giai-co-the/'.$fen, 'langEnUrl' => '/solve-puzzle/'.$fen, 'langJaUrl' => '/pazuru-o-toku/'.$fen, 'langKoUrl' => '/pojeureul-pulda/'.$fen, 'langZhUrl' => '/jiejuenanti/'.$fen, 'canonicalUrl' => '/pojeureul-pulda/'.$fen, 'puzzles' => PostsController::getPuzzles(), 'firstPagePuzzles' => PostsController::getFirstPagePuzzles()]);
})->where(['fen' => $fenRegex]);

Route::match(['get', 'post'], '/ban/{fen}', function ($fen) {
  return view('zh/board', ['headTitle' => '板', 'bodyClass' => 'home', 'fen' => $fen, 'randomRoom' => RoomController::getRandomRoom(), 'roomCode' => '', 'cdnUrl' => URL::to(''), 'langViUrl' => '/ban-co/'.$fen, 'langEnUrl' => '/board/'.$fen, 'langJaUrl' => '/bodo/'.$fen, 'langKoUrl' => '/bodeu/'.$fen, 'langZhUrl' => '/ban/'.$fen, 'canonicalUrl' => '/ban/'.$fen, 'puzzles' => PostsController::getPuzzles(), 'firstPagePuzzles' => PostsController::getFirstPagePuzzles()]);
})->where(['fen' => $fenRegex]);

Route::match(['get', 'post'], '/zuijiandandeban/{fen}', function ($fen) {
return view('zh/boardAi', ['headTitle' => '最简单的板', 'bodyClass' => 'home', 'fen' => $fen, 'randomRoom' => RoomController::getRandomRoom(), 'roomCode' => '', 'level' => '1', 'levelTxt' => '最容易的', 'cdnUrl' => URL::to(''), 'langViUrl' => '/ban-co-de-nhat/'.$fen, 'langEnUrl' => '/easiest-board/'.$fen, 'langJaUrl' => '/mottomo-kantanna-bodo/'.$fen, 'langKoUrl' => '/gajang-swiun-bodeu/'.$fen, 'langZhUrl' => '/zuijiandandeban/'.$fen, 'canonicalUrl' => '/zuijiandandeban/'.$fen, 'puzzles' => PostsController::getPuzzles(), 'firstPagePuzzles' => PostsController::getFirstPagePuzzles()]);
})->where(['fen' => $fenRegex]);
Route::match(['get', 'post'], '/xinshouban/{fen}', function ($fen) {
return view('zh/boardAi', ['headTitle' => '新手板', 'bodyClass' => 'home', 'fen' => $fen, 'randomRoom' => RoomController::getRandomRoom(), 'roomCode' => '', 'level' => '1', 'levelTxt' => '新手', 'cdnUrl' => URL::to(''), 'langViUrl' => '/ban-co-moi-choi/'.$fen, 'langEnUrl' => '/newbie-board/'.$fen, 'langJaUrl' => '/shoshinsha-bodo/'.$fen, 'langKoUrl' => '/nyubi-bodeu/'.$fen, 'langZhUrl' => '/xinshouban/'.$fen, 'canonicalUrl' => '/xinshouban/'.$fen, 'puzzles' => PostsController::getPuzzles(), 'firstPagePuzzles' => PostsController::getFirstPagePuzzles()]);
})->where(['fen' => $fenRegex]);
Route::match(['get', 'post'], '/jianyiban/{fen}', function ($fen) {
return view('zh/boardAi', ['headTitle' => '简易板', 'bodyClass' => 'home', 'fen' => $fen, 'randomRoom' => RoomController::getRandomRoom(), 'roomCode' => '', 'level' => '2', 'levelTxt' => '容易的', 'cdnUrl' => URL::to(''), 'langViUrl' => '/ban-co-de/'.$fen, 'langEnUrl' => '/easy-board/'.$fen, 'langJaUrl' => '/kantan-bodo/'.$fen, 'langKoUrl' => '/iji-bodeu/'.$fen, 'langZhUrl' => '/jianyiban/'.$fen, 'canonicalUrl' => '/jianyiban/'.$fen, 'puzzles' => PostsController::getPuzzles(), 'firstPagePuzzles' => PostsController::getFirstPagePuzzles()]);
})->where(['fen' => $fenRegex]);
Route::match(['get', 'post'], '/putongban/{fen}', function ($fen) {
return view('zh/boardAi', ['headTitle' => '普通板', 'bodyClass' => 'home', 'fen' => $fen, 'randomRoom' => RoomController::getRandomRoom(), 'roomCode' => '', 'level' => '3', 'levelTxt' => '典型的', 'cdnUrl' => URL::to(''), 'langViUrl' => '/ban-co-binh-thuong/'.$fen, 'langEnUrl' => '/normal-board/'.$fen, 'langJaUrl' => '/tsujo-bodo/'.$fen, 'langKoUrl' => '/nomol-bodeu/'.$fen, 'langZhUrl' => '/putongban/'.$fen, 'canonicalUrl' => '/putongban/'.$fen, 'puzzles' => PostsController::getPuzzles(), 'firstPagePuzzles' => PostsController::getFirstPagePuzzles()]);
})->where(['fen' => $fenRegex]);
Route::match(['get', 'post'], '/yingban/{fen}', function ($fen) {
return view('zh/boardAi', ['headTitle' => '硬板', 'bodyClass' => 'home', 'fen' => $fen, 'randomRoom' => RoomController::getRandomRoom(), 'roomCode' => '', 'level' => '4', 'levelTxt' => '坚固的', 'cdnUrl' => URL::to(''), 'langViUrl' => '/ban-co-kho/'.$fen, 'langEnUrl' => '/hard-board/'.$fen, 'langJaUrl' => '/hado-bodo/'.$fen, 'langKoUrl' => '/hadeu-bodeu/'.$fen, 'langZhUrl' => '/yingban/'.$fen, 'canonicalUrl' => '/yingban/'.$fen, 'puzzles' => PostsController::getPuzzles(), 'firstPagePuzzles' => PostsController::getFirstPagePuzzles()]);
})->where(['fen' => $fenRegex]);
Route::match(['get', 'post'], '/zuiyingban/{fen}', function ($fen) {
return view('zh/boardAi', ['headTitle' => '最难的', 'bodyClass' => 'home', 'fen' => $fen, 'randomRoom' => RoomController::getRandomRoom(), 'roomCode' => '', 'level' => '4', 'levelTxt' => '最难的', 'cdnUrl' => URL::to(''), 'langViUrl' => '/ban-co-kho-nhat/'.$fen, 'langEnUrl' => '/hardest-board/'.$fen, 'langJaUrl' => '/mottomo-muzukashi-bodo/'.$fen, 'langKoUrl' => '/gajang-dandanhan-bodeu/'.$fen, 'langZhUrl' => '/zuiyingban/'.$fen, 'canonicalUrl' => '/zuiyingban/'.$fen, 'puzzles' => PostsController::getPuzzles(), 'firstPagePuzzles' => PostsController::getFirstPagePuzzles()]);
})->where(['fen' => $fenRegex]);
Route::match(['get', 'post'], '/jiejuenanti/{fen}', function ($fen) {
return view('zh/puzzleAi', ['headTitle' => '解决难题', 'bodyClass' => 'puzzle', 'fen' => $fen, 'randomRoom' => RoomController::getRandomRoom(), 'roomCode' => '', 'level' => '4', 'levelTxt' => '最难的', 'cdnUrl' => URL::to(''), 'langViUrl' => '/giai-co-the/'.$fen, 'langEnUrl' => '/solve-puzzle/'.$fen, 'langJaUrl' => '/pazuru-o-toku/'.$fen, 'langKoUrl' => '/pojeureul-pulda/'.$fen, 'langZhUrl' => '/jiejuenanti/'.$fen, 'canonicalUrl' => '/jiejuenanti/'.$fen, 'puzzles' => PostsController::getPuzzles(), 'firstPagePuzzles' => PostsController::getFirstPagePuzzles()]);
})->where(['fen' => $fenRegex]);

Route::match(['get', 'post'], '', function () {
return view('ai', ['headTitle' => 'Trang chủ', 'bodyClass' => 'home', 'randomRoom' => RoomController::getRandomRoom(), 'roomCode' => '', 'cdnUrl' => URL::to(''), 'langViUrl' => '', 'langEnUrl' => '/en', 'langJaUrl' => '/ja', 'langKoUrl' => '/ko', 'langZhUrl' => '/zh', 'level' => '3', 'levelTxt' => 'Bình thường', 'canonicalUrl' => '', 'puzzles' => PostsController::getPuzzles(), 'firstPagePuzzles' => PostsController::getFirstPagePuzzles(), 'fenCodes' => PostsController::getFenCodes(), 'books' => PostsController::getBooks(), 'userPuzzles' => PuzzleController::getUserPuzzles(), 'firstUserPuzzles' => PuzzleController::getFirstUserPuzzles(), 'boards' => RoomController::getBoards(), 'firstPageBoards' => RoomController::getFirstPageBoards(), 'playedBoards' => RoomController::getPlayedBoards(), 'firstPagePlayedBoards' => RoomController::getFirstPagePlayedBoards(), 'players' => UserController::getPlayers(), 'firstPagePlayers' => UserController::getFirstPagePlayers()]);
});
Route::match(['get', 'post'], '/de-nhat', function () {
return view('ai', ['headTitle' => 'Dễ nhất', 'bodyClass' => 'home', 'randomRoom' => RoomController::getRandomRoom(), 'roomCode' => '', 'cdnUrl' => URL::to(''), 'langViUrl' => '/de-nhat', 'langEnUrl' => '/easiest', 'langJaUrl' => '/mottomo-kantan', 'langKoUrl' => '/gajang-swiun', 'langZhUrl' => '/zuirongyide', 'level' => '1', 'levelTxt' => 'Dễ nhất', 'canonicalUrl' => '/de-nhat', 'puzzles' => PostsController::getPuzzles(), 'firstPagePuzzles' => PostsController::getFirstPagePuzzles(), 'fenCodes' => PostsController::getFenCodes(), 'books' => PostsController::getBooks(), 'userPuzzles' => PuzzleController::getUserPuzzles(), 'firstUserPuzzles' => PuzzleController::getFirstUserPuzzles(), 'boards' => RoomController::getBoards(), 'firstPageBoards' => RoomController::getFirstPageBoards(), 'playedBoards' => RoomController::getPlayedBoards(), 'firstPagePlayedBoards' => RoomController::getFirstPagePlayedBoards(), 'players' => UserController::getPlayers(), 'firstPagePlayers' => UserController::getFirstPagePlayers()]);
});
Route::match(['get', 'post'], '/moi-choi', function () {
  return view('ai', ['headTitle' => 'Mới chơi', 'bodyClass' => 'home', 'randomRoom' => RoomController::getRandomRoom(), 'roomCode' => '', 'cdnUrl' => URL::to(''), 'langViUrl' => '/moi-choi', 'langEnUrl' => '/newbie', 'langJaUrl' => '/shoshinsha', 'langKoUrl' => '/nyubi', 'langZhUrl' => '/xinshou', 'level' => '1', 'levelTxt' => 'Mới chơi', 'canonicalUrl' => '/moi-choi', 'puzzles' => PostsController::getPuzzles(), 'firstPagePuzzles' => PostsController::getFirstPagePuzzles(), 'fenCodes' => PostsController::getFenCodes(), 'books' => PostsController::getBooks(), 'userPuzzles' => PuzzleController::getUserPuzzles(), 'firstUserPuzzles' => PuzzleController::getFirstUserPuzzles(), 'boards' => RoomController::getBoards(), 'firstPageBoards' => RoomController::getFirstPageBoards(), 'playedBoards' => RoomController::getPlayedBoards(), 'firstPagePlayedBoards' => RoomController::getFirstPagePlayedBoards(), 'players' => UserController::getPlayers(), 'firstPagePlayers' => UserController::getFirstPagePlayers()]);
});
Route::match(['get', 'post'], '/de', function () {
return view('ai', ['headTitle' => 'Dễ', 'bodyClass' => 'home', 'randomRoom' => RoomController::getRandomRoom(), 'roomCode' => '', 'cdnUrl' => URL::to(''), 'langViUrl' => '/de', 'langEnUrl' => '/easy', 'langJaUrl' => '/kantan', 'langKoUrl' => '/iji', 'langZhUrl' => '/rongyide', 'level' => '2', 'levelTxt' => 'Dễ', 'canonicalUrl' => '/de', 'puzzles' => PostsController::getPuzzles(), 'firstPagePuzzles' => PostsController::getFirstPagePuzzles(), 'fenCodes' => PostsController::getFenCodes(), 'books' => PostsController::getBooks(), 'userPuzzles' => PuzzleController::getUserPuzzles(), 'firstUserPuzzles' => PuzzleController::getFirstUserPuzzles(), 'boards' => RoomController::getBoards(), 'firstPageBoards' => RoomController::getFirstPageBoards(), 'playedBoards' => RoomController::getPlayedBoards(), 'firstPagePlayedBoards' => RoomController::getFirstPagePlayedBoards(), 'players' => UserController::getPlayers(), 'firstPagePlayers' => UserController::getFirstPagePlayers()]);
});
Route::match(['get', 'post'], '/binh-thuong', function () {
return view('ai', ['headTitle' => 'Bình thường', 'bodyClass' => 'home', 'randomRoom' => RoomController::getRandomRoom(), 'roomCode' => '', 'cdnUrl' => URL::to(''), 'langViUrl' => '/binh-thuong', 'langEnUrl' => '/normal', 'langJaUrl' => '/tsujo', 'langKoUrl' => '/nomol', 'langZhUrl' => '/dianxingde', 'level' => '3', 'levelTxt' => 'Bình thường', 'canonicalUrl' => '/binh-thuong', 'puzzles' => PostsController::getPuzzles(), 'firstPagePuzzles' => PostsController::getFirstPagePuzzles(), 'fenCodes' => PostsController::getFenCodes(), 'books' => PostsController::getBooks(), 'userPuzzles' => PuzzleController::getUserPuzzles(), 'firstUserPuzzles' => PuzzleController::getFirstUserPuzzles(), 'boards' => RoomController::getBoards(), 'firstPageBoards' => RoomController::getFirstPageBoards(), 'playedBoards' => RoomController::getPlayedBoards(), 'firstPagePlayedBoards' => RoomController::getFirstPagePlayedBoards(), 'players' => UserController::getPlayers(), 'firstPagePlayers' => UserController::getFirstPagePlayers()]);
});
Route::match(['get', 'post'], '/kho', function () {
return view('ai', ['headTitle' => 'Khó', 'bodyClass' => 'home', 'randomRoom' => RoomController::getRandomRoom(), 'roomCode' => '', 'cdnUrl' => URL::to(''), 'langViUrl' => '/kho', 'langEnUrl' => '/hard', 'langJaUrl' => '/muzukashi', 'langKoUrl' => '/hadeu', 'langZhUrl' => '/jiangude', 'level' => '4', 'levelTxt' => 'Khó', 'canonicalUrl' => '/kho', 'puzzles' => PostsController::getPuzzles(), 'firstPagePuzzles' => PostsController::getFirstPagePuzzles(), 'fenCodes' => PostsController::getFenCodes(), 'books' => PostsController::getBooks(), 'userPuzzles' => PuzzleController::getUserPuzzles(), 'firstUserPuzzles' => PuzzleController::getFirstUserPuzzles(), 'boards' => RoomController::getBoards(), 'firstPageBoards' => RoomController::getFirstPageBoards(), 'playedBoards' => RoomController::getPlayedBoards(), 'firstPagePlayedBoards' => RoomController::getFirstPagePlayedBoards(), 'players' => UserController::getPlayers(), 'firstPagePlayers' => UserController::getFirstPagePlayers()]);
});
Route::match(['get', 'post'], '/kho-nhat', function () {
return view('ai', ['headTitle' => 'Khó nhất', 'bodyClass' => 'home', 'randomRoom' => RoomController::getRandomRoom(), 'roomCode' => '', 'cdnUrl' => URL::to(''), 'langViUrl' => '/kho-nhat', 'langEnUrl' => '/hardest', 'langJaUrl' => '/mottomo-muzukashi', 'langKoUrl' => '/gajang-dandanhan', 'langZhUrl' => '/zuinande', 'level' => '4', 'levelTxt' => 'Khó nhất', 'canonicalUrl' => '/kho-nhat', 'puzzles' => PostsController::getPuzzles(), 'firstPagePuzzles' => PostsController::getFirstPagePuzzles(), 'fenCodes' => PostsController::getFenCodes(), 'books' => PostsController::getBooks(), 'userPuzzles' => PuzzleController::getUserPuzzles(), 'firstUserPuzzles' => PuzzleController::getFirstUserPuzzles(), 'boards' => RoomController::getBoards(), 'firstPageBoards' => RoomController::getFirstPageBoards(), 'playedBoards' => RoomController::getPlayedBoards(), 'firstPagePlayedBoards' => RoomController::getFirstPagePlayedBoards(), 'players' => UserController::getPlayers(), 'firstPagePlayers' => UserController::getFirstPagePlayers()]);
});
Route::match(['get', 'post'], '/en', function () {
return view('en/ai', ['headTitle' => 'Home', 'bodyClass' => 'home', 'randomRoom' => RoomController::getRandomRoom(), 'roomCode' => '', 'cdnUrl' => URL::to(''), 'langViUrl' => '', 'langEnUrl' => '/en', 'langJaUrl' => '/ja', 'langKoUrl' => '/ko', 'langZhUrl' => '/zh', 'level' => '3', 'levelTxt' => 'Normal', 'canonicalUrl' => '/en', 'puzzles' => PostsController::getPuzzles(), 'firstPagePuzzles' => PostsController::getFirstPagePuzzles()]);
});
Route::match(['get', 'post'], '/easiest', function () {
return view('en/ai', ['headTitle' => 'Easiest', 'bodyClass' => 'home', 'randomRoom' => RoomController::getRandomRoom(), 'roomCode' => '', 'cdnUrl' => URL::to(''), 'langViUrl' => '/de-nhat', 'langEnUrl' => '/easiest', 'langJaUrl' => '/mottomo-kantan', 'langKoUrl' => '/gajang-swiun', 'langZhUrl' => '/zuirongyide', 'level' => '1', 'levelTxt' => 'Easiest', 'canonicalUrl' => '/easiest', 'puzzles' => PostsController::getPuzzles(), 'firstPagePuzzles' => PostsController::getFirstPagePuzzles()]);
});
Route::match(['get', 'post'], '/newbie', function () {
  return view('en/ai', ['headTitle' => 'Newbie', 'bodyClass' => 'home', 'randomRoom' => RoomController::getRandomRoom(), 'roomCode' => '', 'cdnUrl' => URL::to(''), 'langViUrl' => '/moi-choi', 'langEnUrl' => '/newbie', 'langJaUrl' => '/shoshinsha', 'langKoUrl' => '/nyubi', 'langZhUrl' => '/xinshou', 'level' => '1', 'levelTxt' => 'Newbie', 'canonicalUrl' => '/newbie', 'puzzles' => PostsController::getPuzzles(), 'firstPagePuzzles' => PostsController::getFirstPagePuzzles()]);
});
Route::match(['get', 'post'], '/easy', function () {
return view('en/ai', ['headTitle' => 'Easy', 'bodyClass' => 'home', 'randomRoom' => RoomController::getRandomRoom(), 'roomCode' => '', 'cdnUrl' => URL::to(''), 'langViUrl' => '/de', 'langEnUrl' => '/easy', 'langJaUrl' => '/kantan', 'langKoUrl' => '/iji', 'langZhUrl' => '/rongyide', 'level' => '2', 'levelTxt' => 'Easy', 'canonicalUrl' => '/easy', 'puzzles' => PostsController::getPuzzles(), 'firstPagePuzzles' => PostsController::getFirstPagePuzzles()]);
});
Route::match(['get', 'post'], '/normal', function () {
return view('en/ai', ['headTitle' => 'Normal', 'bodyClass' => 'home', 'randomRoom' => RoomController::getRandomRoom(), 'roomCode' => '', 'cdnUrl' => URL::to(''), 'langViUrl' => '/binh-thuong', 'langEnUrl' => '/normal', 'langJaUrl' => '/tsujo', 'langKoUrl' => '/nomol', 'langZhUrl' => '/dianxingde', 'level' => '3', 'levelTxt' => 'Normal', 'canonicalUrl' => '/normal', 'puzzles' => PostsController::getPuzzles(), 'firstPagePuzzles' => PostsController::getFirstPagePuzzles()]);
});
Route::match(['get', 'post'], '/hard', function () {
return view('en/ai', ['headTitle' => 'Hard', 'bodyClass' => 'home', 'randomRoom' => RoomController::getRandomRoom(), 'roomCode' => '', 'cdnUrl' => URL::to(''), 'langViUrl' => '/kho', 'langEnUrl' => '/hard', 'langJaUrl' => '/muzukashi', 'langKoUrl' => '/hadeu', 'langZhUrl' => '/jiangude', 'level' => '4', 'levelTxt' => 'Hard', 'canonicalUrl' => '/hard', 'puzzles' => PostsController::getPuzzles(), 'firstPagePuzzles' => PostsController::getFirstPagePuzzles()]);
});
Route::match(['get', 'post'], '/hardest', function () {
return view('en/ai', ['headTitle' => 'Hardest', 'bodyClass' => 'home', 'randomRoom' => RoomController::getRandomRoom(), 'roomCode' => '', 'cdnUrl' => URL::to(''), 'langViUrl' => '/kho-nhat', 'langEnUrl' => '/hardest', 'langJaUrl' => '/mottomo-muzukashi', 'langKoUrl' => '/gajang-dandanhan', 'langZhUrl' => '/zuinande', 'level' => '4', 'levelTxt' => 'Hardest', 'canonicalUrl' => '/hardest', 'puzzles' => PostsController::getPuzzles(), 'firstPagePuzzles' => PostsController::getFirstPagePuzzles()]);
});
...
return view('ja/ai', ['headTitle' => 'ホームページ', 'bodyClass' => 'home', 'randomRoom' => RoomController::getRandomRoom(), 'roomCode' => '', 'cdnUrl' => URL::to(''), 'langViUrl' => '', 'langEnUrl' => '/en', 'langJaUrl' => '/ja', 'langKoUrl' => '/ko', 'langZhUrl' => '/zh', 'level' => '3', 'levelTxt' => 'ツジョ', 'canonicalUrl' => '/ja', 'puzzles' => PostsController::getPuzzles(), 'firstPagePuzzles' => PostsController::getFirstPagePuzzles()]);
});
Route::match(['get', 'post'], '/mottomo-kantan', function () {
return view('ja/ai', ['headTitle' => '最も簡単', 'bodyClass' => 'home', 'randomRoom' => RoomController::getRandomRoom(), 'roomCode' => '', 'cdnUrl' => URL::to(''), 'langViUrl' => '/de-nhat', 'langEnUrl' => '/easiest', 'langJaUrl' => '/mottomo-kantan', 'langKoUrl' => '/gajang-swiun', 'langZhUrl' => '/zuirongyide', 'level' => '1', 'levelTxt' => '最も簡単', 'canonicalUrl' => '/mottomo-kantan', 'puzzles' => PostsController::getPuzzles(), 'firstPagePuzzles' => PostsController::getFirstPagePuzzles()]);
});
Route::match(['get', 'post'], '/shoshinsha', function () {
  return view('ja/ai', ['headTitle' => '初心者', 'bodyClass' => 'home', 'randomRoom' => RoomController::getRandomRoom(), 'roomCode' => '', 'cdnUrl' => URL::to(''), 'langViUrl' => '/moi-choi', 'langEnUrl' => '/newbie', 'langJaUrl' => '/shoshinsha', 'langKoUrl' => '/nyubi', 'langZhUrl' => '/xinshou', 'level' => '1', 'levelTxt' => '初心者', 'canonicalUrl' => '/shoshinsha', 'puzzles' => PostsController::getPuzzles(), 'firstPagePuzzles' => PostsController::getFirstPagePuzzles()]);
});
Route::match(['get', 'post'], '/kantan', function () {
return view('ja/ai', ['headTitle' => '簡単', 'bodyClass' => 'home', 'randomRoom' => RoomController::getRandomRoom(), 'roomCode' => '', 'cdnUrl' => URL::to(''), 'langViUrl' => '/de', 'langEnUrl' => '/easy', 'langJaUrl' => '/kantan', 'langKoUrl' => '/iji', 'langZhUrl' => '/rongyide', 'level' => '2', 'levelTxt' => '簡単', 'canonicalUrl' => '/kantan', 'puzzles' => PostsController::getPuzzles(), 'firstPagePuzzles' => PostsController::getFirstPagePuzzles()]);
});
Route::match(['get', 'post'], '/tsujo', function () {
return view('ja/ai', ['headTitle' => 'ツジョ', 'bodyClass' => 'home', 'randomRoom' => RoomController::getRandomRoom(), 'roomCode' => '', 'cdnUrl' => URL::to(''), 'langViUrl' => '/binh-thuong', 'langEnUrl' => '/normal', 'langJaUrl' => '/tsujo', 'langKoUrl' => '/nomol', 'langZhUrl' => '/dianxingde', 'level' => '3', 'levelTxt' => 'ツジョ', 'canonicalUrl' => '/tsujo', 'puzzles' => PostsController::getPuzzles(), 'firstPagePuzzles' => PostsController::getFirstPagePuzzles()]);
});
Route::match(['get', 'post'], '/hado', function () {
return view('ja/ai', ['headTitle' => 'ハード', 'bodyClass' => 'home', 'randomRoom' => RoomController::getRandomRoom(), 'roomCode' => '', 'cdnUrl' => URL::to(''), 'langViUrl' => '/kho', 'langEnUrl' => '/hard', 'langJaUrl' => '/muzukashi', 'langKoUrl' => '/hadeu', 'langZhUrl' => '/jiangude', 'level' => '4', 'levelTxt' => 'ハード', 'canonicalUrl' => '/muzukashi', 'puzzles' => PostsController::getPuzzles(), 'firstPagePuzzles' => PostsController::getFirstPagePuzzles()]);
});
Route::match(['get', 'post'], '/mottomo-muzukashi', function () {
return view('ja/ai', ['headTitle' => '最も難しい', 'bodyClass' => 'home', 'randomRoom' => RoomController::getRandomRoom(), 'roomCode' => '', 'cdnUrl' => URL::to(''), 'langViUrl' => '/kho-nhat', 'langEnUrl' => '/hardest', 'langJaUrl' => '/mottomo-muzukashi', 'langKoUrl' => '/gajang-dandanhan', 'langZhUrl' => '/zuinande', 'level' => '4', 'levelTxt' => '最も難しい', 'canonicalUrl' => '/mottomo-muzukashi', 'puzzles' => PostsController::getPuzzles(), 'firstPagePuzzles' => PostsController::getFirstPagePuzzles()]);
});

Route::match(['get', 'post'], '/ko', function () {
return view('ko/ai', ['headTitle' => '홈페이지', 'bodyClass' => 'home', 'randomRoom' => RoomController::getRandomRoom(), 'roomCode' => '', 'cdnUrl' => URL::to(''), 'langViUrl' => '', 'langEnUrl' => '/en', 'langJaUrl' => '/ja', 'langKoUrl' => '/ko', 'langZhUrl' => '/zh', 'level' => '3', 'levelTxt' => '노멀', 'canonicalUrl' => '/ko', 'puzzles' => PostsController::getPuzzles(), 'firstPagePuzzles' => PostsController::getFirstPagePuzzles()]);
});
Route::match(['get', 'post'], '/gajang-swiun', function () {
return view('ko/ai', ['headTitle' => '가장 쉬운', 'bodyClass' => 'home', 'randomRoom' => RoomController::getRandomRoom(), 'roomCode' => '', 'cdnUrl' => URL::to(''), 'langViUrl' => '/de-nhat', 'langEnUrl' => '/easiest', 'langJaUrl' => '/mottomo-kantan', 'langKoUrl' => '/gajang-swiun', 'langZhUrl' => '/zuirongyide', 'level' => '1', 'levelTxt' => '가장 쉬운', 'canonicalUrl' => '/gajang-swiun', 'puzzles' => PostsController::getPuzzles(), 'firstPagePuzzles' => PostsController::getFirstPagePuzzles()]);
});
Route::match(['get', 'post'], '/nyubi', function () {
  return view('ko/ai', ['headTitle' => '뉴비', 'bodyClass' => 'home', 'randomRoom' => RoomController::getRandomRoom(), 'roomCode' => '', 'cdnUrl' => URL::to(''), 'langViUrl' => '/moi-choi', 'langEnUrl' => '/newbie', 'langJaUrl' => '/shoshinsha', 'langKoUrl' => '/nyubi', 'langZhUrl' => '/xinshou', 'level' => '1', 'levelTxt' => '뉴비', 'canonicalUrl' => '/nyubi', 'puzzles' => PostsController::getPuzzles(), 'firstPagePuzzles' => PostsController::getFirstPagePuzzles()]);
});
Route::match(['get', 'post'], '/iji', function () {
return view('ko/ai', ['headTitle' => '쉬운', 'bodyClass' => 'home', 'randomRoom' => RoomController::getRandomRoom(), 'roomCode' => '', 'cdnUrl' => URL::to(''), 'langViUrl' => '/de', 'langEnUrl' => '/easy', 'langJaUrl' => '/kantan', 'langKoUrl' => '/iji', 'langZhUrl' => '/rongyide', 'level' => '2', 'levelTxt' => '쉬운', 'canonicalUrl' => '/iji', 'puzzles' => PostsController::getPuzzles(), 'firstPagePuzzles' => PostsController::getFirstPagePuzzles()]);
});
Route::match(['get', 'post'], '/nomol', function () {
return view('ko/ai', ['headTitle' => '노멀', 'bodyClass' => 'home', 'randomRoom' => RoomController::getRandomRoom(), 'roomCode' => '', 'cdnUrl' => URL::to(''), 'langViUrl' => '/binh-thuong', 'langEnUrl' => '/normal', 'langJaUrl' => '/tsujo', 'langKoUrl' => '/nomol', 'langZhUrl' => '/dianxingde', 'level' => '3', 'levelTxt' => '노멀', 'canonicalUrl' => '/nomol', 'puzzles' => PostsController::getPuzzles(), 'firstPagePuzzles' => PostsController::getFirstPagePuzzles()]);
});
Route::match(['get', 'post'], '/hadeu', function () {
return view('ko/ai', ['headTitle' => '하드', 'bodyClass' => 'home', 'randomRoom' => RoomController::getRandomRoom(), 'roomCode' => '', 'cdnUrl' => URL::to(''), 'langViUrl' => '/kho', 'langEnUrl' => '/hard', 'langJaUrl' => '/muzukashi', 'langKoUrl' => '/hadeu', 'langZhUrl' => '/jiangude', 'level' => '4', 'levelTxt' => '하드', 'canonicalUrl' => '/hadeu', 'puzzles' => PostsController::getPuzzles(), 'firstPagePuzzles' => PostsController::getFirstPagePuzzles()]);
});
Route::match(['get', 'post'], '/gajang-dandanhan', function () {
return view('ko/ai', ['headTitle' => '가장 단단한', 'bodyClass' => 'home', 'randomRoom' => RoomController::getRandomRoom(), 'roomCode' => '', 'cdnUrl' => URL::to(''), 'langViUrl' => '/kho-nhat', 'langEnUrl' => '/hardest', 'langJaUrl' => '/mottomo-muzukashi', 'langKoUrl' => '/gajang-dandanhan', 'langZhUrl' => '/zuinande', 'level' => '4', 'levelTxt' => '가장 단단한', 'canonicalUrl' => '/gajang-dandanhan', 'puzzles' => PostsController::getPuzzles(), 'firstPagePuzzles' => PostsController::getFirstPagePuzzles()]);
});


Route::match(['get', 'post'], '/zh', function () {
return view('zh/ai', ['headTitle' => '主页', 'bodyClass' => 'home', 'randomRoom' => RoomController::getRandomRoom(), 'roomCode' => '', 'cdnUrl' => URL::to(''), 'langViUrl' => '', 'langEnUrl' => '/en', 'langJaUrl' => '/ja', 'langKoUrl' => '/ko', 'langZhUrl' => '/zh', 'level' => '3', 'levelTxt' => '典型的', 'canonicalUrl' => '/zh', 'puzzles' => PostsController::getPuzzles(), 'firstPagePuzzles' => PostsController::getFirstPagePuzzles()]);
});
Route::match(['get', 'post'], '/zuirongyide', function () {
return view('zh/ai', ['headTitle' => '最容易的', 'bodyClass' => 'home', 'randomRoom' => RoomController::getRandomRoom(), 'roomCode' => '', 'cdnUrl' => URL::to(''), 'langViUrl' => '/de-nhat', 'langEnUrl' => '/easiest', 'langJaUrl' => '/mottomo-kantan', 'langKoUrl' => '/gajang-swiun', 'langZhUrl' => '/zuirongyide', 'level' => '1', 'levelTxt' => '最容易的', 'canonicalUrl' => '/zuirongyide', 'puzzles' => PostsController::getPuzzles(), 'firstPagePuzzles' => PostsController::getFirstPagePuzzles()]);
});
Route::match(['get', 'post'], '/xinshou', function () {
  return view('zh/ai', ['headTitle' => '新手', 'bodyClass' => 'home', 'randomRoom' => RoomController::getRandomRoom(), 'roomCode' => '', 'cdnUrl' => URL::to(''), 'langViUrl' => '/moi-choi', 'langEnUrl' => '/newbie', 'langJaUrl' => '/shoshinsha', 'langKoUrl' => '/nyubi', 'langZhUrl' => '/xinshou', 'level' => '1', 'levelTxt' => '新手', 'canonicalUrl' => '/xinshou', 'puzzles' => PostsController::getPuzzles(), 'firstPagePuzzles' => PostsController::getFirstPagePuzzles()]);
});
Route::match(['get', 'post'], '/rongyide', function () {
return view('zh/ai', ['headTitle' => '容易的', 'bodyClass' => 'home', 'randomRoom' => RoomController::getRandomRoom(), 'roomCode' => '', 'cdnUrl' => URL::to(''), 'langViUrl' => '/de', 'langEnUrl' => '/easy', 'langJaUrl' => '/kantan', 'langKoUrl' => '/iji', 'langZhUrl' => '/rongyide', 'level' => '2', 'levelTxt' => '容易的', 'canonicalUrl' => '/rongyide', 'puzzles' => PostsController::getPuzzles(), 'firstPagePuzzles' => PostsController::getFirstPagePuzzles()]);
});
Route::match(['get', 'post'], '/dianxingde', function () {
return view('zh/ai', ['headTitle' => '典型的', 'bodyClass' => 'home', 'randomRoom' => RoomController::getRandomRoom(), 'roomCode' => '', 'cdnUrl' => URL::to(''), 'langViUrl' => '/binh-thuong', 'langEnUrl' => '/normal', 'langJaUrl' => '/tsujo', 'langKoUrl' => '/nomol', 'langZhUrl' => '/dianxingde', 'level' => '3', 'levelTxt' => '典型的', 'canonicalUrl' => '/dianxingde', 'puzzles' => PostsController::getPuzzles(), 'firstPagePuzzles' => PostsController::getFirstPagePuzzles()]);
});
Route::match(['get', 'post'], '/jiangude', function () {
return view('zh/ai', ['headTitle' => '坚固的', 'bodyClass' => 'home', 'randomRoom' => RoomController::getRandomRoom(), 'roomCode' => '', 'cdnUrl' => URL::to(''), 'langViUrl' => '/kho', 'langEnUrl' => '/hard', 'langJaUrl' => '/muzukashi', 'langKoUrl' => '/hadeu', 'langZhUrl' => '/jiangude', 'level' => '4', 'levelTxt' => '坚固的', 'canonicalUrl' => '/jiangude', 'puzzles' => PostsController::getPuzzles(), 'firstPagePuzzles' => PostsController::getFirstPagePuzzles()]);
});
Route::match(['get', 'post'], '/zuinande', function () {
return view('zh/ai', ['headTitle' => '最难的', 'bodyClass' => 'home', 'randomRoom' => RoomController::getRandomRoom(), 'roomCode' => '', 'cdnUrl' => URL::to(''), 'langViUrl' => '/kho-nhat', 'langEnUrl' => '/hardest', 'langJaUrl' => '/mottomo-muzukashi', 'langKoUrl' => '/gajang-dandanhan', 'langZhUrl' => '/zuinande', 'level' => '4', 'levelTxt' => '最难的', 'canonicalUrl' => '/zuinande', 'puzzles' => PostsController::getPuzzles(), 'firstPagePuzzles' => PostsController::getFirstPagePuzzles()]);
});
